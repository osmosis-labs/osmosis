...
* [#6267](https://github.com/osmosis-labs/osmosis/pull/6267) codeql: add codeql query to look for usages of native go's binary operators between sdk/osmo numerical types (ex: sdk.Dec == sdk.
