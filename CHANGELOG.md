...
* [#3827](https://github.com/osmosis-labs/osmosis/pull/3907) Add swaprouter queries `Numpools`, `EstimateSwapExactAmountIn` and `EstimateSwapExactAmountOut` to stargate whitelist.
