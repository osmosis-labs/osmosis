...
// Query to get pool liquidity and amount of each denoms' pool shares.
...
// Query to get spot price of denoms.
...
// Validates each denom (in / out) and performs a swap.
