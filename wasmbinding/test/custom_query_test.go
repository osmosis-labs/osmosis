...
func TestJoinPoolSharesQuery(t *testing.T) {
	...
	query = bindings.OsmosisQuery{
		JoinPoolShares: &bindings.JoinPoolShares{PoolId: starPool, Coins: sdk.NewCoins(sdk.NewCoin("uosmo", sdk.NewInt(1_200_000)), sdk.NewCoin("ustar", sdk.NewInt(24_000_000)))},
	}
	joinPoolSharesResp := bindings.JoinPoolSharesResponse{}
