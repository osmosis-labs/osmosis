...
func TestDenomAdmin(t *testing.T) {
	...
	queryPlugin := wasmbinding.NewQueryPlugin(app.GAMMKeeper, app.TwapKeeper, app.TokenFactoryKeeper, app.SwapRouterKeeper)
...
func TestPoolState(t *testing.T) {
	...
	queryPlugin := wasmbinding.NewQueryPlugin(osmosis.GAMMKeeper, osmosis.TwapKeeper, osmosis.TokenFactoryKeeper, osmosis.SwapRouterKeeper)
