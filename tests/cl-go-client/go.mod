...
require (
	...
	github.com/osmosis-labs/osmosis/osmoutils v0.0.0-20230529060317-d6d2dda0fb22 // indirect
	github.com/osmosis-labs/osmosis/v16 v16.0.0-20230607130515-971283a67849 // indirect
