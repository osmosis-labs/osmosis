...
add_genesis_accounts () {
    ...
    while [ $i -le 100 ]; do
        ...
        osmosisd add-genesis-account lo-test"$testacc1" 10000000000000000uosmo,10000000000000000uion,10000000000000000stake,10000000000000000uusdc,10000000000000000uweth --home $OSMOSIS_HOME --keyring-backend test
