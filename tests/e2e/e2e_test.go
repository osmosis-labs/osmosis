...
func (s *IntegrationTestSuite) TestConcentratedLiquidity() {
	...
	chainANode.CreateConcentratedPosition(address1, "[-120000]", "40000", "10000000", "10000000", 0, 0, poolID)
	chainANode.CreateConcentratedPosition(address1, "[-40000]", "120000", "10000000", "10000000", 0, 0, poolID)

	// Create 1 position for address2: does not overlap with anything, ends at maximum
	chainANode.CreateConcentratedPosition(address2, "220000", fmt.Sprintf("%d", cltypes.MaxTick), "10000000", "10000000", 0, 0, poolID)
