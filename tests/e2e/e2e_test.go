...
func (s *IntegrationTestSuite) TestConcentratedLiquidity() {
	...
	node.WithdrawPosition(address1, "[-1200]", "400", defaultLiquidityRemoval, poolID, positionsAddress1[0].Position.JoinTime, positionsAddress1[0].Position.FreezeDuration.String(), 1)
	// assert
	positionsAddress1 = node.QueryConcentratedPositions(address1)
	...
	node.WithdrawPosition(address2, "2200", fmt.Sprintf("%d", maxTick), defaultLiquidityRemoval, poolID, positionsAddress2[0].Position.JoinTime, positionsAddress1[0].Position.FreezeDuration.String(), 3)
	// assert
	positionsAddress2 = node.QueryConcentratedPositions(address2)
	...
	node.WithdrawPosition(address3, "[-1600]", "[-200]", defaultLiquidityRemoval, poolID, positionsAddress3[0].Position.JoinTime, positionsAddress3[0].Position.FreezeDuration.String(), 4)
	// assert
	positionsAddress3 = node.QueryConcentratedPositions(address3)
	...
	node.WithdrawPosition(address2, "2200", fmt.Sprintf("%d", maxTick), allLiquidityAddress2Position1.String(), poolID, positionsAddress2[0].Position.JoinTime, positionsAddress2[0].Position.FreezeDuration.String(), 3)
	positionsAddress2 = node.QueryConcentratedPositions(address2)
