...
MSG=$(jenv -c '{"swap_contract": $SWAPROUTER_ADDRESS, "track_ibc_sends": true, "channels": [["juno", $OSMOSIS_CHANNEL]]}')
...
MEMO=$(jenv -c '{"wasm": {"contract": $CROSSCHAIN_SWAPS_ADDRESS, "msg": {"osmosis_swap":{"input_coin":{"denom":$DENOM,"amount":"100"},"output_denom":"uosmo","slippage":{"max_slippage_percentage":"20"},"receiver":$VALIDATOR_JUNO}}}}')
