...
# TODO - osmosis-ci DNE (unless it's private). Currently referencing the PR that removed the release workflow.
- The GitHub release is handled by [osmosis-ci](https://github.com/osmosis-labs/osmosis/pull/2428).
