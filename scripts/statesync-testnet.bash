...
symphonyd init test --chain-id melody-test-4 
# wget -O ~/.symphonyd/config/genesis.json https://cloudflare-ipfs.com/ipfs/QmXRvBT3hgoXwwPqbK6a2sXUuArGM8wPyo1ybskyyUwUxs

INTERVAL=1500

# GET TRUST HASH AND TRUST HEIGHT

LATEST_HEIGHT=$(curl -s https://rpc-test.symphony.zone/block | jq -r .result.block.header.height);
BLOCK_HEIGHT=$(($LATEST_HEIGHT-$INTERVAL))
TRUST_HASH=$(curl -s "https://rpc-test.symphony.zone/block?height=$BLOCK_HEIGHT" | jq -r .result.block_id.hash)
...
export OSMOSISD_STATESYNC_RPC_SERVERS="https://rpc-test.symphony.zone:443,https://rpc-test.symphony.zone:443"
