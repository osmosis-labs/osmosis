...
e2e-docker-build-debug:
	@DOCKER_BUILDKIT=1 docker build --build-arg BUILD_TAGS="excludeIncrement" -t osmosis:${COMMIT} --build-arg BASE_IMG_TAG=debug --build-arg RUNNER_IMAGE=$(RUNNER_BASE_IMAGE_ALPINE) -f Dockerfile .
