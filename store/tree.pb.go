...
type Child struct {
	...
	Accumulation github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=accumulation,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"accumulation" yaml:"accumulation"`
}
...
func (m *Child) GetAccumulation() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Accumulation
	}
	return nil
}
...
var fileDescriptor_72b0b7af579d13be = []byte{
	...
	,
}
...
func (m *Child) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Accumulation) > 0 {
		for iNdEx := len(m.Accumulation) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Accumulation[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Child) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Accumulation = append(m.Accumulation, types.Coin{})
			if err := m.Accumulation[len(m.Accumulation)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
