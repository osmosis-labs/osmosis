...
osmosisd prepare-genesis mainnet testing --home=$HOME/.osmosisd
...
osmosisd gentx validator 500000000uosmo --keyring-backend=test --home=$HOME/.osmosisd --chain-id=testing
