...
func init() {
	file_osmosis_app_v1alpha1_module_proto_init()
	md_ModuleDescriptor = File_osmosis_app_v1alpha1_module_proto.Messages().ByName("ModuleDescriptor")
...
func (x *ModuleDescriptor) slowProtoReflect() protoreflect.Message {
	mi := &file_osmosis_app_v1alpha1_module_proto_msgTypes[0]
...
func (x *fastReflection_ModuleDescriptor) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "osmosis.app.v1alpha1.ModuleDescriptor.go_import":
		return x.GoImport != ""
	case "osmosis.app.v1alpha1.ModuleDescriptor.use_package":
		return len(x.UsePackage) != 0
	case "osmosis.app.v1alpha1.ModuleDescriptor.can_migrate_from":
		return len(x.CanMigrateFrom) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: osmosis.app.v1alpha1.ModuleDescriptor"))
		}
		panic(fmt.Errorf("message osmosis.app.v1alpha1.ModuleDescriptor does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ModuleDescriptor) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message osmosis.app.v1alpha1.ModuleDescriptor does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ModuleDescriptor) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "osmosis.app.v1alpha1.ModuleDescriptor.can_migrate_from":
		...
		return protoreflect.ValueOfList(value)
	case "osmosis.app.v1alpha1.ModuleDescriptor.go_import":
		panic(fmt.Errorf("field go_import of message osmosis.app.v1alpha1.ModuleDescriptor is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: osmosis.app.v1alpha1.ModuleDescriptor"))
		}
...
func (x *fastReflection_ModuleDescriptor) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in osmosis.app.v1alpha1.ModuleDescriptor", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_osmosis_app_v1alpha1_module_proto_init()
	md_PackageReference = File_osmosis_app_v1alpha1_module_proto.Messages().ByName("PackageReference")
...
func (x *PackageReference) slowProtoReflect() protoreflect.Message {
	mi := &file_osmosis_app_v1alpha1_module_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PackageReference) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "osmosis.app.v1alpha1.PackageReference.name":
		return x.Name != ""
	case "osmosis.app.v1alpha1.PackageReference.revision":
		return x.Revision != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: osmosis.app.v1alpha1.PackageReference"))
		}
		panic(fmt.Errorf("message osmosis.app.v1alpha1.PackageReference does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PackageReference) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message osmosis.app.v1alpha1.PackageReference does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PackageReference) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "osmosis.app.v1alpha1.PackageReference.name":
		panic(fmt.Errorf("field name of message osmosis.app.v1alpha1.PackageReference is not mutable"))
	case "osmosis.app.v1alpha1.PackageReference.revision":
		panic(fmt.Errorf("field revision of message osmosis.app.v1alpha1.PackageReference is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: osmosis.app.v1alpha1.PackageReference"))
		}
...
func (x *fastReflection_PackageReference) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in osmosis.app.v1alpha1.PackageReference", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_osmosis_app_v1alpha1_module_proto_init()
	md_MigrateFromInfo = File_osmosis_app_v1alpha1_module_proto.Messages().ByName("MigrateFromInfo")
...
func (x *MigrateFromInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_osmosis_app_v1alpha1_module_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MigrateFromInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "osmosis.app.v1alpha1.MigrateFromInfo.module":
		return x.Module != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: osmosis.app.v1alpha1.MigrateFromInfo"))
		}
		panic(fmt.Errorf("message osmosis.app.v1alpha1.MigrateFromInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MigrateFromInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message osmosis.app.v1alpha1.MigrateFromInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MigrateFromInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "osmosis.app.v1alpha1.MigrateFromInfo.module":
		panic(fmt.Errorf("field module of message osmosis.app.v1alpha1.MigrateFromInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: osmosis.app.v1alpha1.MigrateFromInfo"))
		}
...
func (x *fastReflection_MigrateFromInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in osmosis.app.v1alpha1.MigrateFromInfo", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: osmosis/app/v1alpha1/module.proto
...
func (*ModuleDescriptor) Descriptor() ([]byte, []int) {
	return file_osmosis_app_v1alpha1_module_proto_rawDescGZIP(), []int{0}
}
...
func (*PackageReference) Descriptor() ([]byte, []int) {
	return file_osmosis_app_v1alpha1_module_proto_rawDescGZIP(), []int{1}
}
...
func (*MigrateFromInfo) Descriptor() ([]byte, []int) {
	return file_osmosis_app_v1alpha1_module_proto_rawDescGZIP(), []int{2}
}
...
var file_osmosis_app_v1alpha1_module_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.MessageOptions)(nil),
		ExtensionType: (*ModuleDescriptor)(nil),
		Field:         57193480,
		Name:          "osmosis.app.v1alpha1.module",
		Tag:           "bytes,57193480,opt,name=module",
		Filename:      "osmosis/app/v1alpha1/module.proto",
	},
}
...
var (
	...
	//
	// optional osmosis.app.v1alpha1.ModuleDescriptor module = 57193480;
	E_Module = &file_osmosis_app_v1alpha1_module_proto_extTypes[0]
)

var File_osmosis_app_v1alpha1_module_proto protoreflect.FileDescriptor

var file_osmosis_app_v1alpha1_module_proto_rawDesc = []byte{
	0x0a, 0x21, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x69, 0x73, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x76, 0x31,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x14, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x69, 0x73, 0x2e, 0x61, 0x70, 0x70,
	...
	0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x69, 0x73, 0x2e, 0x61, 0x70, 0x70,
	...
	0x32, 0x25, 0x2e, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x69, 0x73, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76,
	...
	0x73, 0x18, 0x88, 0xe8, 0xa2, 0x1b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x69, 0x73, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61,
	0x31, 0x2e, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74,
	0x6f, 0x72, 0x52, 0x06, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x42, 0xe3, 0x01, 0x0a, 0x18, 0x63,
	0x6f, 0x6d, 0x2e, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x69, 0x73, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76,
	...
	,
}

var (
	file_osmosis_app_v1alpha1_module_proto_rawDescOnce sync.Once
	file_osmosis_app_v1alpha1_module_proto_rawDescData = file_osmosis_app_v1alpha1_module_proto_rawDesc
)

func file_osmosis_app_v1alpha1_module_proto_rawDescGZIP() []byte {
	file_osmosis_app_v1alpha1_module_proto_rawDescOnce.Do(func() {
		file_osmosis_app_v1alpha1_module_proto_rawDescData = protoimpl.X.CompressGZIP(file_osmosis_app_v1alpha1_module_proto_rawDescData)
	})
	return file_osmosis_app_v1alpha1_module_proto_rawDescData
}

var file_osmosis_app_v1alpha1_module_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_osmosis_app_v1alpha1_module_proto_goTypes = []interface{}{
	(*ModuleDescriptor)(nil),            // 0: osmosis.app.v1alpha1.ModuleDescriptor
	(*PackageReference)(nil),            // 1: osmosis.app.v1alpha1.PackageReference
	(*MigrateFromInfo)(nil),             // 2: osmosis.app.v1alpha1.MigrateFromInfo
	(*descriptorpb.MessageOptions)(nil), // 3: google.protobuf.MessageOptions
}
var file_osmosis_app_v1alpha1_module_proto_depIdxs = []int32{
	1, // 0: osmosis.app.v1alpha1.ModuleDescriptor.use_package:type_name -> osmosis.app.v1alpha1.PackageReference
	2, // 1: osmosis.app.v1alpha1.ModuleDescriptor.can_migrate_from:type_name -> osmosis.app.v1alpha1.MigrateFromInfo
	3, // 2: osmosis.app.v1alpha1.module:extendee -> google.protobuf.MessageOptions
	0, // 3: osmosis.app.v1alpha1.module:type_name -> osmosis.app.v1alpha1.ModuleDescriptor
...
func init() { file_osmosis_app_v1alpha1_module_proto_init() }
func file_osmosis_app_v1alpha1_module_proto_init() {
	if File_osmosis_app_v1alpha1_module_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_osmosis_app_v1alpha1_module_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_osmosis_app_v1alpha1_module_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_osmosis_app_v1alpha1_module_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_osmosis_app_v1alpha1_module_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_osmosis_app_v1alpha1_module_proto_goTypes,
		DependencyIndexes: file_osmosis_app_v1alpha1_module_proto_depIdxs,
		MessageInfos:      file_osmosis_app_v1alpha1_module_proto_msgTypes,
		ExtensionInfos:    file_osmosis_app_v1alpha1_module_proto_extTypes,
	}.Build()
	File_osmosis_app_v1alpha1_module_proto = out.File
	file_osmosis_app_v1alpha1_module_proto_rawDesc = nil
	file_osmosis_app_v1alpha1_module_proto_goTypes = nil
	file_osmosis_app_v1alpha1_module_proto_depIdxs = nil
}
