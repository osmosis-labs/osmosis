...
require (
	...
	github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v4 v4.0.0-20230803151532-5c60ac789ef7
	github.com/cosmos/ibc-apps/modules/async-icq/v4 v4.0.0-20230427160352-9b0745532735
