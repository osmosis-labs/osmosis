...
replace (
	...
	// always use the version of osmomath corresponding with this release and branch
	github.com/osmosis-labs/osmosis/osmomath => ./osmomath
	// always use the version of osmoutils corresponding with this release and branch
