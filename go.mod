...
require (
	...
	github.com/osmosis-labs/osmosis/osmomath v0.0.3-dev
...
replace (
	// use most up to date ibc v8-ish
	github.com/cosmos/ibc-go/v7 => github.com/notional-labs/ibc-go/v7 v7.0.0-20230803085622-1f0e922246a8
