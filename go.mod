...
require (
	...
	github.com/osmosis-labs/osmosis/osmomath v0.0.7-0.20231215224000-752eff6548a4
	github.com/osmosis-labs/osmosis/osmoutils v0.0.7-0.20231202014129-59ba6328b7ca
