...
replace (
	...
	// Our cosmos-sdk branch is:  https://github.com/osmosis-labs/cosmos-sdk (branch: osmosis-main)
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.45.1-0.20221213195007-48fe175f9839
