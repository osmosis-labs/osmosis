...
replace (
	// Our cosmos-sdk branch is:  https://github.com/osmosis-labs/cosmos-sdk  faddat/v0.44.3x-osmorocks
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.43.0-rc3.0.20220204140749-f0a4429de767
