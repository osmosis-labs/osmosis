...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.45.1-0.20220302155942-19b4f3c852d3

	github.com/cosmos/iavl => github.com/osmosis-labs/iavl v0.17.3-osmo-v4.rc2
