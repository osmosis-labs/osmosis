...
replace (
	// Our cosmos-sdk branch is:  https://github.com/osmosis-labs/cosmos-sdk  v0.44.3x-osmo-v5, tag: v0.44.3x-osmo-v5.rc1
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.44.4-0.20220222221527-3d57be25a993
	github.com/cosmos/iavl => github.com/osmosis-labs/iavl v0.17.3-osmo-v4.rc1
