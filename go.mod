...
require (
	...
	github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v4 v4.0.0-20230811142731-42d48cb0b0d5
...
replace (
	...
	github.com/cosmos/ibc-go/v4 => github.com/nicolaslara/ibc-go/v4 v4.20.22
