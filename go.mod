...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.44.4-0.20220221220505-473c15f3622e
	github.com/cosmos/iavl => github.com/osmosis-labs/iavl v0.17.3-osmo-v4.rc0
