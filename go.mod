...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.43.0-rc3.0.20220218040216-ec4c1ea567ff
	github.com/cosmos/iavl => github.com/osmosis-labs/iavl v0.17.3-osmo-v2.rc2
