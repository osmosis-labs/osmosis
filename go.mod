...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.44.4-0.20220418155904-9b94fe231e87
	...
	// tm-db
	github.com/tendermint/tm-db => github.com/notional-labs/tm-db v0.6.7-0.20220418122228-de3850cbdaad
