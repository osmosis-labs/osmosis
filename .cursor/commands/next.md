...
3. **Add any discovered tasks** to `tasks.md` as you work:
   - Prerequisites that should have been done first
   - Follow-up work out of scope for current task
   - Investigations for risks or issues found
   - Include clear descriptions and acceptance criteria
4. Update `knowledge.md` with decisions or learnings
5. Update `references.md` with new references and quality notes
6. Mark task as `✅ completed` in `tasks.md`
7. Commit progress to git when appropriate
8. Request confirmation before starting a different task
