...
func (s *SQSBlockProcessorTestSuite) TestProcessBlock_UpdatesOnlyStrategy() {
	...
	for _, tt := range tests {
		s.Run(tt.name, func() {
			...
			// System under test
			newBlockProcessor := blockprocessor.NewBlockUpdatesSQSBlockProcessStrategy(uninitialzedGRPClient, uninitializedTransformer, poolsExtracter, transformAndLoadMock.TransformAndLoad)
