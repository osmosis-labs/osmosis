...
func NewBlockUpdatesSQSBlockProcessStrategy(sqsGRPCClient domain.SQSGRPClient, poolsTransformer domain.PoolsTransformer, poolExtractor commondomain.PoolExtractor, transformAndLoadFunc transformAndLoadFunc) *BlockUpdatesSQSBlockProcessStrategy {
