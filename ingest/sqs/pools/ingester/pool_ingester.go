...
func NewPoolIngester(keepers domain.SQSIngestKeepers) domain.BlockProcessor {
	return &poolIngester{
...
// Process implements ingest.Ingester.
func (pi *poolIngester) Process(ctx sdk.Context) ([]sqsdomain.PoolI, sqsdomain.TakerFeeMap, error) {
	return pi.processPoolState(ctx)
}

var _ domain.BlockProcessor = &poolIngester{}
