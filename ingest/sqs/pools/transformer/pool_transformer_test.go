...
var (
	...
	emptyDenomPairToTakerFeeMap = types.TakerFeeMap{}
...
func (s *PoolTransformerTestSuite) TestConvertPool_EmptyPriceInfoMap_TakerFee() {
	...
	expectedDenomPairToTakerFeeMap := types.TakerFeeMap{
		{
			Denom0: USDC,
			Denom1: USDT,
...
func (s *PoolTransformerTestSuite) validatePoolConversion(expectedPool poolmanagertypes.PoolI, expectedPoolLiquidityCap osmomath.Int, expectPoolLiquidityCapError string, actualPool types.PoolI, expectedBalances sdk.Coins) {
	// Correct ID
