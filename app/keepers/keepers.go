...
func (appKeepers *AppKeepers) InitNormalKeepers(
	...
	wasmOpts = append(owasm.RegisterCustomPlugins(appKeepers.GAMMKeeper, appKeepers.BankKeeper, appKeepers.TokenFactoryKeeper, appKeepers.LockupKeeper), wasmOpts...)
