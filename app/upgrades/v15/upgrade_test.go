...
func (suite *UpgradeTestSuite) TestRemoveExitFee() {
	...
	pool2Bz, err := hex.DecodeString("")
	store.Set(gammtypes.GetKeyPrefixPools(3), pool2Bz)
	...
	pool2, err := suite.App.GAMMKeeper.GetPool(suite.Ctx, 3)
