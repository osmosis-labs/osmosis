...
// The change being, transfering all liquid funds from consenting addresses to
...
func AgreedUponIrregularStateChange(ctx sdk.Context, keepers *keepers.AppKeepers) {
	...
	ForceTransferAllTokens(ctx, keepers, addr, RecoveryAddress)
