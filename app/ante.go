...
func NewAnteHandler(
	...
	return sdk.ChainAnteDecorators(
		...
		// UNFORKINGTODO C: I think this is correct in using nil for NewExtensionOptionsDecorator to reject all, but want ACK
		...
		// UNFORKINGTODO C: I think this is correct in changing NewAnteDecorator to NewRedundantRelayDecorator, but want ACK
