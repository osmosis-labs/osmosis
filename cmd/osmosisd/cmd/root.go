...
var (
	//go:embed "osmosis-1-assetlist.json" "osmo-test-5-assetlist.json" "app.config.tpl"
	assetFS           embed.FS
	mainnetId         = "osmosis-1"
	testnetId         = "osmo-test-5"
	appConfigTemplate = "app.config.tpl"
)
...
func initAppConfig() (string, interface{}) {
	...
	OsmosisAppTemplate := serverconfig.DefaultConfigTemplate + appConfigTemplate + wasmtypes.DefaultConfigTemplate()
