  ...
  .links {
    ...
    .search-box {
      ...
      input {
        ...
        font-size: 1rem;
        padding: 0;
        background: rgba($borderColor) url('/osmosis/img/search.svg') 0.75rem center no-repeat;
      ...
      top: $mobile-navbar-vertical-padding;
        .search-box {
          ...
          input {
            ...
            background: rgba($borderColor) url('/osmosis/img/search.svg') 0.625rem center no-repeat;
            left: 0;
