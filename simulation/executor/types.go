...
type ContentSimulatorFn func(r *rand.Rand, ctx sdk.Context, accs []simtypes.Account) Content
...
type Operation func(r *rand.Rand, app *baseapp.BaseApp,
	ctx sdk.Context, accounts []simtypes.Account, chainID string) (
...
type TypesParams interface {
	PastEvidenceFraction() float64
	NumKeys() int
	EvidenceFraction() float64
	InitialLivenessWeightings() []int
	LivenessTransitionMatrix() simtypes.TransitionMatrix
	BlockSizeTransitionMatrix() simtypes.TransitionMatrix
}
