...
import (
	...
	types3 "github.com/osmosis-labs/osmosis/v17/x/pool-incentives/types"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type GroupGauge struct {
	...
	DistrInfo       types3.DistrInfo `protobuf:"bytes,2,opt,name=distr_info,json=distrInfo,proto3" json:"distr_info"`
...
func (m *GroupGauge) GetDistrInfo() types3.DistrInfo {
	if m != nil {
		return m.DistrInfo
	}
...
var fileDescriptor_c0304e2bb0159901 = []byte{
	...
	,
}
