...
type Params struct {
	...
	// min_osmo_value_for_distribution is the minimum amount a token must be worth
	// in terms of OSMO to be eligible for distribution. If the token is worth
	// less than this amount, it will not be distributed and is forfeited to the
	// remaining distributees that are eligible.
	MinOsmoValueForDistribution cosmossdk_io_math.Int `protobuf:"bytes,5,opt,name=min_osmo_value_for_distribution,json=minOsmoValueForDistribution,proto3,customtype=cosmossdk.io/math.Int" json:"min_osmo_value_for_distribution" yaml:"min_osmo_value_for_distribution"`
}
...
var fileDescriptor_1cc8b460d089f845 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.MinOsmoValueForDistribution.Size()
		i -= size
		if _, err := m.MinOsmoValueForDistribution.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
	...
	i--
	dAtA[i] = 0x2a
	n1, err1 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.InternalUptime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.InternalUptime):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovParams(uint64(l))
	l = m.MinOsmoValueForDistribution.Size()
	n += 1 + l + sovParams(uint64(l))
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinOsmoValueForDistribution", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MinOsmoValueForDistribution.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
