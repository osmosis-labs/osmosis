...
func (m *CurrentRewardResponse) GetEpoch() int64 {
	if m != nil {
		return m.Epoch
	}
	return 0
...
func (m *HistoricalRewardRequest) GetEpochNumber() int64 {
	if m != nil {
...
type HistoricalRewardResponse struct {
	...
	LastEligibleEpoch     int64                                       `protobuf:"varint,2,opt,name=last_eligible_epoch,json=lastEligibleEpoch,proto3" json:"last_eligible_epoch,omitempty"`
}
...
func (m *HistoricalRewardResponse) GetLastEligibleEpoch() int64 {
	if m != nil {
...
var fileDescriptor_8124258a89427f98 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastEligibleEpoch |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
