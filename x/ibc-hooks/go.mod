...
replace (
	...
	// https://github.com/osmosis-labs/cometbft/releases/tag/v0.37.4-v25-osmo-3
	github.com/cometbft/cometbft => github.com/osmosis-labs/cometbft v0.37.4-v25-osmo-3
