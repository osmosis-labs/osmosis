...
replace (
	...
	// https://github.com/osmosis-labs/cometbft/releases/tag/v0.37.4-v25-osmo-7
	github.com/cometbft/cometbft => github.com/osmosis-labs/cometbft v0.37.5-0.20240617193056-14b79ada6832

	// v1.0.0-beta.3 is incompatible, so we use v1.0.0-beta.2
	github.com/cosmos/cosmos-proto => github.com/cosmos/cosmos-proto v1.0.0-beta.2
	// Branch: Branch: osmo/v0.47.5
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.47.6-0.20240617193052-89027ae292aa
