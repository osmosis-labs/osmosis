...
import (
	...
	cl "github.com/osmosis-labs/osmosis/v15/x/cliq"
	"github.com/osmosis-labs/osmosis/v15/x/cliq/client/queryproto"
	"github.com/osmosis-labs/osmosis/v15/x/cliq/math"
	"github.com/osmosis-labs/osmosis/v15/x/cliq/model"
	"github.com/osmosis-labs/osmosis/v15/x/cliq/types"
	"github.com/osmosis-labs/osmosis/v15/x/cliq/types/genesis"
)
...
func (s *KeeperTestSuite) TestTickOrdering() {
	...
	s.App.ConcentratedLiquidityKeeper = cl.NewKeeper(s.App.AppCodec(), storeKey, s.App.AccountKeeper, s.App.BankKeeper, s.App.GAMMKeeper, s.App.PoolIncentivesKeeper, s.App.IncentivesKeeper, s.App.LockupKeeper, s.App.GetSubspace(types.ModuleName))
