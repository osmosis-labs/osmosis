...
type Minter struct {
	...
	// last_total_inflation_amount represents the total amount of inflation
	// tokens minted since the chain launched. It excludes developer vesting
	// rewards that are estimated separately by last_total_vested_amount.
	LastTotalInflationAmount github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=last_total_inflation_amount,json=lastTotalInflationAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"last_total_inflation_amount" yaml:"last_total_minted_amount"`
	// last_total_vested_amount represents the total amount of developer
	// reward tokens vested since the chain launched.
	LastTotalVestedAmount github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=last_total_vested_amount,json=lastTotalVestedAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"last_total_vested_amount" yaml:"last_minted_total_amount"`
}
...
var fileDescriptor_ccb38f8335e0f45b = []byte{
	...
	,
}
...
func (m *Minter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.LastTotalVestedAmount.Size()
		i -= size
		if _, err := m.LastTotalVestedAmount.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
	...
	dAtA[i] = 0x1a
	{
		size := m.LastTotalInflationAmount.Size()
		i -= size
		if _, err := m.LastTotalInflationAmount.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintMint(dAtA, i, uint64(size))
	}
...
func (m *Minter) Size() (n int) {
	...
	l = m.LastTotalInflationAmount.Size()
	n += 1 + l + sovMint(uint64(l))
	l = m.LastTotalVestedAmount.Size()
	n += 1 + l + sovMint(uint64(l))
	return n
}
...
func (m *Minter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastTotalInflationAmount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LastTotalInflationAmount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastTotalVestedAmount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LastTotalVestedAmount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
