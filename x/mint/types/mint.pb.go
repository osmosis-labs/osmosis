...
type Minter struct {
	...
	// last_total_minted_amount represents the total amount of tokens minted since
	// the chain launched.
	// TODO: explain the difference from supply and supply with offset.
	LastTotalMintedAmount github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=last_total_minted_amount,json=lastTotalMintedAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"last_total_minted_amount" yaml:"last_total_minted_amount"`
...
var fileDescriptor_ccb38f8335e0f45b = []byte{
	...
	,
}
...
func (m *Minter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	{
		size := m.LastTotalMintedAmount.Size()
		i -= size
		if _, err := m.LastTotalMintedAmount.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintMint(dAtA, i, uint64(size))
	}
...
func (m *Minter) Size() (n int) {
	...
	l = m.LastTotalMintedAmount.Size()
	n += 1 + l + sovMint(uint64(l))
...
func (m *Minter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastTotalMintedAmount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LastTotalMintedAmount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
