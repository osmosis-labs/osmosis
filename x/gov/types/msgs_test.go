...
func TestMsgDepositGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"osmosis/MsgDeposit","value":{"amount":[{"amount":"1000","denom":"stake"}],"depositor":"cosmos1v9jxgu33kfsgr5","proposal_id":"0"}}`
...
func TestMsgSubmitProposal_GetSignBytes(t *testing.T) {
	...
	require.Equal(t,
		`{"type":"osmosis/MsgSubmitProposal","value":{"content":{"type":"osmosis/TextProposal","value":{"description":"abcd","title":"test"}},"initial_deposit":[]}}`,
		string(bz))
}
