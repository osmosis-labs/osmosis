...
```bash
content:
  '@type': /osmosis.gov.v1beta1.TextProposal
...
```bash
osmosis.gov.v1beta1.Query/Proposal
```
...
```bash
{
  "proposal": {
    "proposalId": "1",
    "content": {"@type":"/osmosis.gov.v1beta1.TextProposal","description":"testing, testing, 1, 2, 3","title":"Test Proposal"},
...
```bash
osmosis.gov.v1beta1.Query/Proposals
```
...
```bash
osmosis.gov.v1beta1.Query/Vote
```
...
```bash
osmosis.gov.v1beta1.Query/Votes
```
...
```bash
osmosis.gov.v1beta1.Query/Params
```
...
```bash
osmosis.gov.v1beta1.Query/Deposit
```
...
```bash
osmosis.gov.v1beta1.Query/Deposits
```
...
```bash
osmosis.gov.v1beta1.Query/TallyResult
```
