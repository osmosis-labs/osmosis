...
Request types are defined in the [authenticator/requests.go](https://github.com/osmosis-labs/osmosis/blob/main/x/smart-account/authenticator/requests.go) file in this module.
