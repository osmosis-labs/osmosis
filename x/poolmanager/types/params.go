...
var (
	...
	KeyTakerFeeByPassWhitelist                        = []byte("TakerFeeByPassWhitelist")
)
...
func (p Params) Validate() error {
	...
	if err := osmoutils.ValidateAddressList(p.TakerFeeParams.BypassWhitelist); err != nil {
		return err
	}
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyTakerFeeByPassWhitelist, &p.TakerFeeParams.BypassWhitelist, osmoutils.ValidateAddressList),
	}
}
