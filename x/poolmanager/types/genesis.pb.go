...
type TakerFeeParams struct {
	...
	// revenue_sharer_fee is the portion of the taker fee that is sent to the revenue sharer
	RevenueShareFee cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=revenue_sharer_fee,json=revenueSharerFee,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"revenue_sharer_fee"`
}
...
var fileDescriptor_aa099d9fbdf68b35 = []byte{
	...
	,
}
...
func (m *TakerFeeParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.RevenueShareFee.Size()
		i -= size
		if _, err := m.RevenueShareFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintGenesis(dAtA, i, uint64(size))
	}
...
func (m *TakerFeeParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RevenueShareFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RevenueShareFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
