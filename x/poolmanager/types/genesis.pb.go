...
type Params struct {
	...
	// min_value_for_route declares what the minimum value a pool must
	// be worth in order to be considered for inclusion in the in-state
	// pool router.
	MinValueForRoute types.Coin `protobuf:"bytes,4,opt,name=min_value_for_route,json=minValueForRoute,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coin" json:"min_value_for_route"`
}
...
func (m *Params) GetMinValueForRoute() types.Coin {
	if m != nil {
		return m.MinValueForRoute
	}
	return types.Coin{}
}
...
var fileDescriptor_aa099d9fbdf68b35 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.MinValueForRoute.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinValueForRoute", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MinValueForRoute.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
