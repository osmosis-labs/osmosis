...
type TakerFeeParams struct {
	...
	// bypass_whitelist is a list of addresses that are
	// allowed to bypass the taker fee when performing a swap
	...
	BypassWhitelist []string `protobuf:"bytes,6,rep,name=bypass_whitelist,json=bypassWhitelist,proto3" json:"bypass_whitelist,omitempty" yaml:"bypass_whitelist"`
}
...
func (m *TakerFeeParams) GetBypassWhitelist() []string {
	if m != nil {
		return m.BypassWhitelist
	}
	return nil
}
...
var fileDescriptor_aa099d9fbdf68b35 = []byte{
	...
	,
}
...
func (m *TakerFeeParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BypassWhitelist) > 0 {
		for iNdEx := len(m.BypassWhitelist) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.BypassWhitelist[iNdEx])
			copy(dAtA[i:], m.BypassWhitelist[iNdEx])
			i = encodeVarintGenesis(dAtA, i, uint64(len(m.BypassWhitelist[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
...
func (m *TakerFeeParams) Size() (n int) {
	...
	if len(m.BypassWhitelist) > 0 {
		for _, s := range m.BypassWhitelist {
			l = len(s)
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *TakerFeeParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BypassWhitelist", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BypassWhitelist = append(m.BypassWhitelist, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenesis(dAtA[iNdEx:])
