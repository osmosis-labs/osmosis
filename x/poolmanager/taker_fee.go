...
func (k Keeper) chargeTakerFee(ctx sdk.Context, tokenIn sdk.Coin, tokenOutDenom string, sender sdk.AccAddress, exactIn bool) (sdk.Coin, error) {
	...
	if takerFeeCoin.Denom == defaultTakerFeeDenom {
		...
		// Community Pool:
		if osmoTakerFeeDistribution.CommunityPool.GT(zeroDec) {
		...
		// Staking Rewards:
		if osmoTakerFeeDistribution.StakingRewards.GT(zeroDec) {
		...
		// Community Pool:
		if nonOsmoTakerFeeDistribution.CommunityPool.GT(zeroDec) {
		...
		// Staking Rewards:
		if nonOsmoTakerFeeDistribution.StakingRewards.GT(zeroDec) {
