...
// are set to the module. Each record has a specified pot id and weight, and the
// incetives are distributed to each pot according to weight/total_weight. The
// incentives are put in the fee pool and it is allocated to pots and community
// pool by the DistrRecords configuration. Note. when potId=0, the amount is
...
var fileDescriptor_96caede426ba9516 = []byte{
	...
	0x58, 0xf1, 0x74, 0x2c, 0x90, 0x67, 0x98, 0xb1, 0x40, 0x9e, 0xe1, 0xc5, 0x02, 0x79, 0x46, 0xa7,
	...
	0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x87, 0xda, 0xa6, 0x9b, 0x93, 0x98, 0x54, 0x0c, 0xe3,
	0xe8, 0x57, 0x60, 0x84, 0x4c, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38, 0x34, 0x8c, 0x01,
	0x01, 0x00, 0x00, 0xff, 0xff, 0x0b, 0xe1, 0x32, 0x23, 0xa2, 0x01, 0x00, 0x00,
}
