...
In the current design, we hardcode $exponentAtPriceOne$ as -6 with a tick spacing of 100. This effectively acts as an $exponentAtPriceOne$ of -4.

When $exponentAtPriceOne = -4$ , each tick starting at 1 and ending at the first factor of 10 will represents a spot price increase of 0.0001:
...
For spot prices less than a dollar, the precision factor decreases at every factor of 10:
