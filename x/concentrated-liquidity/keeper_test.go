...
var (
	...
	LargeCoin0                                     = sdk.NewCoin(ETH, sdk.NewInt(100000000000))
	LargeCoin1                                     = sdk.NewCoin(USDC, sdk.NewInt(500000000000000))
)
...
func (s *KeeperTestSuite) SetupDefaultPositionAcc(poolId uint64, owner sdk.AccAddress) {
	s.SetupPosition(poolId, owner, LargeCoin0, LargeCoin1, DefaultLowerTick, DefaultUpperTick, s.Ctx.BlockTime().Add(DefaultFreezeDuration))
}

func (s *KeeperTestSuite) SetupFullRangePositionAcc(poolId uint64, owner sdk.AccAddress) {
	s.SetupPosition(poolId, owner, LargeCoin0, LargeCoin1, DefaultMinTick, DefaultMaxTick, s.Ctx.BlockTime().Add(DefaultFreezeDuration))
}

func (s *KeeperTestSuite) SetupConsecutiveRangePositionAcc(poolId uint64, owner sdk.AccAddress) {
	s.SetupPosition(poolId, owner, LargeCoin0, LargeCoin1, DefaultExponentConsecutivePositionLowerTick.Int64(), DefaultExponentConsecutivePositionUpperTick.Int64(), s.Ctx.BlockTime().Add(DefaultFreezeDuration))
}

func (s *KeeperTestSuite) SetupOverlappingRangePositionAcc(poolId uint64, owner sdk.AccAddress) {
	s.SetupPosition(poolId, owner, LargeCoin0, LargeCoin1, DefaultExponentOverlappingPositionLowerTick.Int64(), DefaultExponentOverlappingPositionUpperTick.Int64(), s.Ctx.BlockTime().Add(DefaultFreezeDuration))
}
