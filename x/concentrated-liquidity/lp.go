...
func (k Keeper) createPosition(ctx sdk.Context, poolId uint64, owner sdk.AccAddress, tokensProvided sdk.Coins, amount0Min, amount1Min sdk.Int, lowerTick, upperTick int64) (positionId uint64, actualAmount0 sdk.Int, actualAmount1 sdk.Int, liquidityDelta sdk.Dec, lowerTickResult int64, upperTickResult int64, err error) {
	...
	fmt.Printf("creating position %s %s %d %d \n", actualAmount0.String()+pool.GetToken0(), actualAmount1.String()+pool.GetToken1(), lowerTick, upperTick)
...
func (k Keeper) WithdrawPosition(ctx sdk.Context, owner sdk.AccAddress, positionId uint64, requestedLiquidityAmountToWithdraw sdk.Dec) (amtDenom0, amtDenom1 sdk.Int, err error) {
	...
	fmt.Printf("withdrawPosition %s %s \n", actualAmount0.Abs().String(), actualAmount1.Abs().String())
