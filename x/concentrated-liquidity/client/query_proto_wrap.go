...
func (q Querier) TotalLiquidityForRange(ctx sdk.Context, req clquery.TotalLiquidityForRangeRequest) (*clquery.TotalLiquidityForRangeResponse, error) {
	...
	return &clquery.TotalLiquidityForRangeResponse{Liquidity: liquidity}, nil
}
