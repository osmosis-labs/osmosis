...
func GetLiquidityFromAmounts(sqrtPrice osmomath.BigDec, sqrtPriceA, sqrtPriceB osmomath.Dec, amount0, amount1 osmomath.Int) (liquidity osmomath.Dec) {
	sqrtPriceABigDec := osmomath.BigDecFromDec(sqrtPriceA)
	sqrtPriceBBigDec := osmomath.BigDecFromDec(sqrtPriceB)
