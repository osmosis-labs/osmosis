...
func (k Keeper) initOrUpdateAccumPosition(ctx sdk.Context, accumumulator *accum.AccumulatorObject, accumulatorValuePerShare osmomath.DecCoins, index string, numShareUnits osmomath.Dec, unclaimedRewardsTotal osmomath.DecCoins, options *accum.Options) {
