...
const (
	...
	// executed with malicious intent in begin block code. This is an unlikely scenario
	// as long as contract deployment is gated by governance and protorev/txfee swaps are
	// on whitelisted tokens, but letting contract calls take unbounded gas in these scenarios
	// is a risk we don't want to take regardless.
