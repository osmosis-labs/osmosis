...
func (m *QueryLiquidityDepthsForRangeRequest) GetLowerTick() int64 {
	if m != nil {
		return m.LowerTick
	}
	return 0
...
func (m *QueryLiquidityDepthsForRangeRequest) GetUpperTick() int64 {
	if m != nil {
		return m.UpperTick
	}
	return 0
...
type QueryTickLiquidityInBatchesRequest struct {
	...
	LowerTick int64  `protobuf:"varint,2,opt,name=lower_tick,json=lowerTick,proto3" json:"lower_tick,omitempty" yaml:"lower_tick"`
	UpperTick int64  `protobuf:"varint,3,opt,name=upper_tick,json=upperTick,proto3" json:"upper_tick,omitempty" yaml:"upper_tick"`
	// batch_unit indicates the spacing between each tick being queried.
	// e.g) if batch unit provided is 5 and lower tick provided is 10,
	// query for tick liquidity would be done in units of 5: 10, 15, 20....
	BatchUnit uint64 `protobuf:"varint,4,opt,name=batch_unit,json=batchUnit,proto3" json:"batch_unit,omitempty" yaml:"batch_unit"`
}
...
func (m *QueryTickLiquidityInBatchesRequest) GetLowerTick() int64 {
	if m != nil {
		return m.LowerTick
	}
	return 0
...
func (m *QueryTickLiquidityInBatchesRequest) GetUpperTick() int64 {
	if m != nil {
		return m.UpperTick
	}
	return 0
...
var fileDescriptor_ce34c1e206115391 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// TickLiquidityInBatches returns liquidity depth in units of provided batch
	// units.
