...
func request_Query_TickInfo_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	protoReq.Tick, err = runtime.Int64(val)
...
var (
	...
	pattern_Query_TickInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"osmosis", "concentratedliquidity", "v1beta1", "pools", "pool_id", "tick"}, "", runtime.AssumeColonVerbOpt(false)))
