	...
	tests := []struct {
	...
	}{
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:           1,
				UpperTick:           10,
				TokenDesiredAmount0: sdk.OneInt(),
				TokenDesiredAmount1: sdk.OneInt(),
		...
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:           1,
				UpperTick:           10,
				TokenDesiredAmount0: sdk.NewInt(-10),
				TokenDesiredAmount1: sdk.OneInt(),
				TokenMinAmount0:     sdk.OneInt(),
				TokenMinAmount1:     sdk.OneInt(),
			},
		...
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				UpperTick:           10,
				TokenDesiredAmount0: sdk.OneInt(),
				TokenDesiredAmount1: sdk.NewInt(-10),
				TokenMinAmount0:     sdk.OneInt(),
				TokenMinAmount1:     sdk.OneInt(),
			},
			expectPass: false,
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:           1,
				UpperTick:           10,
				TokenDesiredAmount0: sdk.ZeroInt(),
				TokenDesiredAmount1: sdk.ZeroInt(),
				TokenMinAmount0:     sdk.OneInt(),
				TokenMinAmount1:     sdk.OneInt(),
			},
			expectPass: false,
	...
	testCases := []struct {
		...
		},
		{
			...
			clMsg: &types.MsgCreatePosition{
				...
				TokenDesiredAmount0: sdk.NewInt(1000),
				TokenDesiredAmount1: sdk.NewInt(1000),
				TokenMinAmount0:     sdk.OneInt(),
				TokenMinAmount1:     sdk.OneInt(),
			},
		},
