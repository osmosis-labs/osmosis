...
type QueryLiquidityNetInDirectionResponse struct {
	LiquidityDepths  []LiquidityDepth                       `protobuf:"bytes,1,rep,name=liquidity_depths,json=liquidityDepths,proto3" json:"liquidity_depths"`
	CurrentLiquidity github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=current_liquidity,json=currentLiquidity,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"current_liquidity" yaml:"current_liquidity"`
}
...
func (*QueryClaimableFeesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce34c1e206115391, []int{16}
}
...
func (*QueryClaimableFeesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce34c1e206115391, []int{17}
}
...
var fileDescriptor_ce34c1e206115391 = []byte{
	...
	,
}
