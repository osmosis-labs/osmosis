...
func (s *KeeperTestSuite) createPosition(accountIndex int, poolId uint64, coin0, coin1 sdk.Coin, lowerTick, upperTick int64) {
...
func (s *KeeperTestSuite) TestAndCreatePosition() {
	...
	err = os.WriteFile("a.json", stateBz, 0o644)
	if err != nil {
		panic(err)
	}
}
