...
func (am AppModule) Actions() []simtypes.Action {
	return []simtypes.Action{
		...
		simtypes.NewMsgBasedAction("CLSwapExactAmountIn", am.keeper, simulation.RandomCLSwapExactAmountIn),
		simtypes.NewMsgBasedAction("CLSwapExactAmountOut", am.keeper, simulation.RandomCLSwapExactAmountOut),
