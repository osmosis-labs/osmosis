...
type ActivitiesResponse struct {
	...
	Withdrawn []string `protobuf:"bytes,4,rep,name=withdrawn,proto3" json:"withdrawn,omitempty"`
}
...
func (m *ActivitiesResponse) GetWithdrawn() []string {
	if m != nil {
		return m.Withdrawn
	}
	return nil
...
var fileDescriptor_1bba73508cdd8c1d = []byte{
	...
	,
}
...
func (m *ActivitiesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Withdrawn) > 0 {
		for iNdEx := len(m.Withdrawn) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Withdrawn[iNdEx])
			copy(dAtA[i:], m.Withdrawn[iNdEx])
			i = encodeVarintQuery(dAtA, i, uint64(len(m.Withdrawn[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *ActivitiesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Withdrawn = append(m.Withdrawn, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
