...
import (
	...
	"github.com/osmosis-labs/osmosis/vv23/x/superfluid/keeper/internal/events"
...
func (h Hooks) BeforeValidatorSlashed(ctx sdk.Context, valAddr sdk.ValAddress, slashFactor osmomath.Dec) error {
