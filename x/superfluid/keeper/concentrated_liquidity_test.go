...
func (s *KeeperTestSuite) TestAddToConcentratedLiquiditySuperfluidPosition() {
	...
	testCases := map[string]sendTest{
		"add to position that is superfluid delegated, not unlocking": {
			...
			amount0Added:        osmomath.NewInt(10000000000),
			amount1Added:        osmomath.NewInt(10000000000),
		},
		"error: negative amount 0": {
			...
			amount0Added:        osmomath.NewInt(-10000000000),
			amount1Added:        osmomath.NewInt(10000000000),
			expectedError:       cltypes.NegativeAmountAddedError{PositionId: 1, Asset0Amount: osmomath.NewInt(-10000000000), Asset1Amount: osmomath.NewInt(10000000000)},
		},
