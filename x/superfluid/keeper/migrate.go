...
func (k Keeper) UnlockAndMigrate(ctx sdk.Context, sender sdk.AccAddress, lockId uint64, sharesToMigrate sdk.Coin) (amount0, amount1 sdk.Int, liquidity sdk.Dec, poolIdLeaving, poolIdEntering, newLockId uint64, frozenUntil time.Time, err error) {
	...
	if err != nil {
		return sdk.Int{}, sdk.Int{}, sdk.Dec{}, 0, 0, 0, time.Time{}, err
	}
	...
	if len(exitCoins) != 2 {
		return sdk.Int{}, sdk.Int{}, sdk.Dec{}, 0, 0, 0, time.Time{}, fmt.Errorf("Balancer pool must have exactly two tokens")
	}
	...
	return amount0, amount1, liquidity, poolIdLeaving, poolIdEntering, newLockId, frozenUntil, nil
}
