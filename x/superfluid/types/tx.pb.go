...
type MsgLockExistingFullRangePositionAndSFStake struct {
	PositionId uint64 `protobuf:"varint,1,opt,name=position_id,json=positionId,proto3" json:"position_id,omitempty" yaml:"position_id"`
	Sender     string `protobuf:"bytes,2,opt,name=sender,proto3" json:"sender,omitempty" yaml:"sender"`
	ValAddr    string `protobuf:"bytes,3,opt,name=val_addr,json=valAddr,proto3" json:"val_addr,omitempty" yaml:"val_addr"`
}

func (m *MsgLockExistingFullRangePositionAndSFStake) Reset() {
	*m = MsgLockExistingFullRangePositionAndSFStake{}
}
func (m *MsgLockExistingFullRangePositionAndSFStake) String() string {
	return proto.CompactTextString(m)
}
func (*MsgLockExistingFullRangePositionAndSFStake) ProtoMessage() {}
func (*MsgLockExistingFullRangePositionAndSFStake) Descriptor() ([]byte, []int) {
	return fileDescriptor_55b645f187d22814, []int{18}
}
func (m *MsgLockExistingFullRangePositionAndSFStake) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgLockExistingFullRangePositionAndSFStake) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStake.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgLockExistingFullRangePositionAndSFStake) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStake.Merge(m, src)
}
func (m *MsgLockExistingFullRangePositionAndSFStake) XXX_Size() int {
	return m.Size()
}
func (m *MsgLockExistingFullRangePositionAndSFStake) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStake.DiscardUnknown(m)
}

var xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStake proto.InternalMessageInfo

func (m *MsgLockExistingFullRangePositionAndSFStake) GetPositionId() uint64 {
	if m != nil {
		return m.PositionId
	}
	return 0
...
func (m *MsgLockExistingFullRangePositionAndSFStake) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *MsgLockExistingFullRangePositionAndSFStake) GetValAddr() string {
	if m != nil {
		return m.ValAddr
	}
	return ""
...
type MsgLockExistingFullRangePositionAndSFStakeResponse struct {
	ConcentratedLockId uint64 `protobuf:"varint,1,opt,name=concentrated_lock_id,json=concentratedLockId,proto3" json:"concentrated_lock_id,omitempty" yaml:"concentrated_lock_id"`
}

func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) Reset() {
	*m = MsgLockExistingFullRangePositionAndSFStakeResponse{}
}
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) String() string {
	return proto.CompactTextString(m)
}
func (*MsgLockExistingFullRangePositionAndSFStakeResponse) ProtoMessage() {}
func (*MsgLockExistingFullRangePositionAndSFStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_55b645f187d22814, []int{19}
}
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStakeResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStakeResponse.Merge(m, src)
}
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStakeResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgLockExistingFullRangePositionAndSFStakeResponse proto.InternalMessageInfo

func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) GetConcentratedLockId() uint64 {
	if m != nil {
		return m.ConcentratedLockId
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*MsgLockExistingFullRangePositionAndSFStake)(nil), "osmosis.superfluid.MsgLockExistingFullRangePositionAndSFStake")
	proto.RegisterType((*MsgLockExistingFullRangePositionAndSFStakeResponse)(nil), "osmosis.superfluid.MsgLockExistingFullRangePositionAndSFStakeResponse")
}
...
type MsgClient interface {
	...
	LockExistingFullRangePositionAndSFStake(ctx context.Context, in *MsgLockExistingFullRangePositionAndSFStake, opts ...grpc.CallOption) (*MsgLockExistingFullRangePositionAndSFStakeResponse, error)
}
...
func (c *msgClient) LockExistingFullRangePositionAndSFStake(ctx context.Context, in *MsgLockExistingFullRangePositionAndSFStake, opts ...grpc.CallOption) (*MsgLockExistingFullRangePositionAndSFStakeResponse, error) {
	out := new(MsgLockExistingFullRangePositionAndSFStakeResponse)
	err := c.cc.Invoke(ctx, "/osmosis.superfluid.Msg/LockExistingFullRangePositionAndSFStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	LockExistingFullRangePositionAndSFStake(context.Context, *MsgLockExistingFullRangePositionAndSFStake) (*MsgLockExistingFullRangePositionAndSFStakeResponse, error)
}
...
func (*UnimplementedMsgServer) LockExistingFullRangePositionAndSFStake(ctx context.Context, req *MsgLockExistingFullRangePositionAndSFStake) (*MsgLockExistingFullRangePositionAndSFStakeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LockExistingFullRangePositionAndSFStake not implemented")
}
...
func _Msg_LockExistingFullRangePositionAndSFStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgLockExistingFullRangePositionAndSFStake)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).LockExistingFullRangePositionAndSFStake(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.superfluid.Msg/LockExistingFullRangePositionAndSFStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).LockExistingFullRangePositionAndSFStake(ctx, req.(*MsgLockExistingFullRangePositionAndSFStake))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LockExistingFullRangePositionAndSFStake",
			Handler:    _Msg_LockExistingFullRangePositionAndSFStake_Handler,
		},
	},
...
func (m *MsgLockExistingFullRangePositionAndSFStake) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgLockExistingFullRangePositionAndSFStake) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgLockExistingFullRangePositionAndSFStake) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.ConcentratedLockId != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.ConcentratedLockId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MsgLockExistingFullRangePositionAndSFStake) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ConcentratedLockId != 0 {
		n += 1 + sovTx(uint64(m.ConcentratedLockId))
	}
	return n
}
...
func (m *MsgLockExistingFullRangePositionAndSFStake) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgLockExistingFullRangePositionAndSFStake: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgLockExistingFullRangePositionAndSFStake: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *MsgLockExistingFullRangePositionAndSFStakeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgLockExistingFullRangePositionAndSFStakeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgLockExistingFullRangePositionAndSFStakeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConcentratedLockId", wireType)
			}
			m.ConcentratedLockId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConcentratedLockId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
