...
import (
	...
	types2 "github.com/osmosis-labs/osmosis/v25/x/lockup/types"
...
type SuperfluidAsset struct {
	...
	PriceRoute []*types.SwapAmountInRoute `protobuf:"bytes,3,rep,name=price_route,json=priceRoute,proto3" json:"price_route,omitempty"`
}
...
type SuperfluidDelegationRecord struct {
	...
	DelegationAmount       types1.Coin  `protobuf:"bytes,3,opt,name=delegation_amount,json=delegationAmount,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coin" json:"delegation_amount"`
	EquivalentStakedAmount *types1.Coin `protobuf:"bytes,4,opt,name=equivalent_staked_amount,json=equivalentStakedAmount,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coin" json:"equivalent_staked_amount,omitempty"`
}
...
func (m *SuperfluidDelegationRecord) GetDelegationAmount() types1.Coin {
	if m != nil {
...
func (m *SuperfluidDelegationRecord) GetEquivalentStakedAmount() *types1.Coin {
	if m != nil {
...
type ConcentratedPoolUserPositionRecord struct {
	...
	SyntheticLock          types2.SyntheticLock `protobuf:"bytes,4,opt,name=synthetic_lock,json=syntheticLock,proto3" json:"synthetic_lock"`
	DelegationAmount       types1.Coin          `protobuf:"bytes,5,opt,name=delegation_amount,json=delegationAmount,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coin" json:"delegation_amount"`
	EquivalentStakedAmount *types1.Coin         `protobuf:"bytes,6,opt,name=equivalent_staked_amount,json=equivalentStakedAmount,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coin" json:"equivalent_staked_amount,omitempty"`
}
...
func (m *ConcentratedPoolUserPositionRecord) GetSyntheticLock() types2.SyntheticLock {
	if m != nil {
		return m.SyntheticLock
	}
	return types2.SyntheticLock{}
}

func (m *ConcentratedPoolUserPositionRecord) GetDelegationAmount() types1.Coin {
	if m != nil {
		return m.DelegationAmount
	}
	return types1.Coin{}
...
func (m *ConcentratedPoolUserPositionRecord) GetEquivalentStakedAmount() *types1.Coin {
	if m != nil {
		return m.EquivalentStakedAmount
	}
	return nil
...
func (m *DenomRiskFactor) Reset()         { *m = DenomRiskFactor{} }
func (m *DenomRiskFactor) String() string { return proto.CompactTextString(m) }
func (*DenomRiskFactor) ProtoMessage()    {}
func (*DenomRiskFactor) Descriptor() ([]byte, []int) {
	return fileDescriptor_79d3c29d82dbb734, []int{7}
}
func (m *DenomRiskFactor) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DenomRiskFactor) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DenomRiskFactor.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DenomRiskFactor) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DenomRiskFactor.Merge(m, src)
}
func (m *DenomRiskFactor) XXX_Size() int {
	return m.Size()
}
func (m *DenomRiskFactor) XXX_DiscardUnknown() {
	xxx_messageInfo_DenomRiskFactor.DiscardUnknown(m)
}

var xxx_messageInfo_DenomRiskFactor proto.InternalMessageInfo

func (m *DenomRiskFactor) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*DenomRiskFactor)(nil), "osmosis.superfluid.DenomRiskFactor")
}
...
var fileDescriptor_79d3c29d82dbb734 = []byte{
	...
	,
}
...
func (this *SuperfluidAsset) Equal(that interface{}) bool {
	...
	if len(this.PriceRoute) != len(that1.PriceRoute) {
		return false
	}
	for i := range this.PriceRoute {
		if !this.PriceRoute[i].Equal(that1.PriceRoute[i]) {
			return false
		}
	}
	return true
...
func (m *SuperfluidAsset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PriceRoute) > 0 {
		for iNdEx := len(m.PriceRoute) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PriceRoute[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DenomRiskFactor) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DenomRiskFactor) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DenomRiskFactor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DenomRiskFactor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SuperfluidAsset) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PriceRoute", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PriceRoute = append(m.PriceRoute, &types.SwapAmountInRoute{})
			if err := m.PriceRoute[len(m.PriceRoute)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SuperfluidDelegationRecord) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.EquivalentStakedAmount == nil {
				m.EquivalentStakedAmount = &types1.Coin{}
			}
...
func (m *DenomRiskFactor) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DenomRiskFactor: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DenomRiskFactor: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
