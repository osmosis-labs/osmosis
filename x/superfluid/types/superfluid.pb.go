...
type SuperfluidAsset struct {
	...
	// twap of the asset
	PricePoolIds []uint64 `protobuf:"varint,3,rep,packed,name=price_pool_ids,json=pricePoolIds,proto3" json:"price_pool_ids,omitempty"`
}
...
var fileDescriptor_79d3c29d82dbb734 = []byte{
	...
	,
}
...
func (this *SuperfluidAsset) Equal(that interface{}) bool {
	...
	if len(this.PricePoolIds) != len(that1.PricePoolIds) {
		return false
	}
	for i := range this.PricePoolIds {
		if this.PricePoolIds[i] != that1.PricePoolIds[i] {
			return false
		}
	}
	return true
...
func (m *SuperfluidAsset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PricePoolIds) > 0 {
		dAtA2 := make([]byte, len(m.PricePoolIds)*10)
		var j1 int
		for _, num := range m.PricePoolIds {
			for num >= 1<<7 {
		...
		i = encodeVarintSuperfluid(dAtA, i, uint64(j1))
		i--
		dAtA[i] = 0x1a
	}
	if m.AssetType != 0 {
...
func (m *UnpoolWhitelistedPools) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Ids) > 0 {
		...
		i = encodeVarintSuperfluid(dAtA, i, uint64(j5))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				m.PricePoolIds = append(m.PricePoolIds, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.PricePoolIds) == 0 {
					m.PricePoolIds = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field PricePoolIds", wireType)
			}
		default:
			iNdEx = preIndex
