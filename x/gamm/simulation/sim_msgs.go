...
func deriveRealMinShareOutAmt(ctx sdk.Context, tokenIn sdk.Coins, pool types.CFMMI) (sdk.Int, error) {
...
func getRandPool(k keeper.Keeper, sim *simtypes.SimCtx, ctx sdk.Context) (uint64, types.CFMMI, sdk.Coin, sdk.Coin, []string, string, error) {
