...
```golang
	...
	JoinPool(tokensIn sdk.Coins, spreadFactor osmomath.Dec) (numShares sdk.Int, err error)
	JoinPoolNoSwap(tokensIn sdk.Coins, spreadFactor osmomath.Dec) (numShares sdk.Int, err error)
	ExitPool(numShares sdk.Int, exitFee osmomath.Dec) (exitedCoins sdk.Coins, err error)
```
