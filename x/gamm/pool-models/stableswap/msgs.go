...
func (msg MsgCreateStableswapPool) CreatePool(ctx sdk.Context, poolId uint64, takerFee sdk.Dec) (poolmanagertypes.PoolI, error) {
	msg.PoolParams.TakerFee = takerFee
