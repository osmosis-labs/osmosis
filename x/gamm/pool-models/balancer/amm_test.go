...
func TestCalcJoinPoolShares(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectShares: sdk.NewInt(2_499_999_968_750), // Current actual: 2_499_999_968_800 // TODO: understand why
		...
		},
		{
			...
			expectShares: sdk.NewInt(2_487_500_000_000), // Current actual: 2_487_499_969_100
			expectLiq:    sdk.NewCoins(sdk.NewInt64Coin("uosmo", 50_000)),
		},
	}
