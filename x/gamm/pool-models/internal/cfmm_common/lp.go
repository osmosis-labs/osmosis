...
func CalcExitPool(ctx sdk.Context, pool types.CFMMI, exitingShares sdk.Int, exitFee sdk.Dec) (sdk.Coins, error) {
...
func MaximalExactRatioJoin(p types.CFMMI, ctx sdk.Context, tokensIn sdk.Coins) (numShares sdk.Int, remCoins sdk.Coins, err error) {
...
func BinarySearchSingleAssetJoin(
	pool types.CFMMI,
	tokenIn sdk.Coin,
	poolWithAddedLiquidityAndShares func(newLiquidity sdk.Coin, newShares sdk.Int) types.CFMMI,
...
func SwapAllCoinsToSingleAsset(pool types.CFMMI, ctx sdk.Context, inTokens sdk.Coins, swapToDenom string,
