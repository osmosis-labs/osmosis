...
func TestSlippageRelationWithLiquidityIncrease(
	...
	t *testing.T,
	ctx sdk.Context,
	createPoolWithLiquidity func(sdk.Context, sdk.Coins) types.CFMMI,
...
func isWithinBounds(ctx sdk.Context, pool types.CFMMI, tokenOut sdk.Coins, tokenInDenom string, swapFee sdk.Dec) (b bool) {
	b = true
	defer func() {
		if r := recover(); r != nil {
			b = false
