...
// LinkBalancerPoolWithCLPoolProposal contains a balancer_pool_id that
// wants to be linked with CL_pool.
type LinkBalancerPoolWithCLPoolProposal struct {
	Title       string                           `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description string                           `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	Records     []BalancerToConcentratedPoolLink `protobuf:"bytes,3,rep,name=records,proto3" json:"records"`
}

func (m *LinkBalancerPoolWithCLPoolProposal) Reset()      { *m = LinkBalancerPoolWithCLPoolProposal{} }
func (*LinkBalancerPoolWithCLPoolProposal) ProtoMessage() {}
func (*LinkBalancerPoolWithCLPoolProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_f31b9a6c0dbbdfa3, []int{2}
}
func (m *LinkBalancerPoolWithCLPoolProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LinkBalancerPoolWithCLPoolProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LinkBalancerPoolWithCLPoolProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LinkBalancerPoolWithCLPoolProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LinkBalancerPoolWithCLPoolProposal.Merge(m, src)
}
func (m *LinkBalancerPoolWithCLPoolProposal) XXX_Size() int {
	return m.Size()
}
func (m *LinkBalancerPoolWithCLPoolProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_LinkBalancerPoolWithCLPoolProposal.DiscardUnknown(m)
}

var xxx_messageInfo_LinkBalancerPoolWithCLPoolProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*LinkBalancerPoolWithCLPoolProposal)(nil), "osmosis.gamm.v1beta1.LinkBalancerPoolWithCLPoolProposal")
}
...
var fileDescriptor_f31b9a6c0dbbdfa3 = []byte{
	...
	0x42, 0x0d, 0x16, 0x10, 0xf8, 0x3d, 0xa9, 0xd4, 0xcb, 0xc4, 0xa5, 0x04, 0xb6, 0x0e, 0xea, 0x18,
	0x90, 0xf5, 0xe1, 0x99, 0x25, 0x19, 0xce, 0x3e, 0x20, 0xd6, 0x20, 0x0d, 0x8b, 0x48, 0xd2, 0xc2,
	0x42, 0x0b, 0x16, 0x16, 0x84, 0x3d, 0xea, 0xe4, 0x75, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72,
	...
	0x03, 0x75, 0x73, 0x12, 0x93, 0x8a, 0x61, 0x1c, 0xfd, 0x32, 0x43, 0x33, 0xfd, 0x0a, 0x48, 0x5e,
	0x2d, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x67, 0x3a, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0xea, 0xc0, 0x0a, 0xf9, 0x14, 0x04, 0x00, 0x00,
}
...
func (this *LinkBalancerPoolWithCLPoolProposal) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LinkBalancerPoolWithCLPoolProposal)
	if !ok {
		that2, ok := that.(LinkBalancerPoolWithCLPoolProposal)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *LinkBalancerPoolWithCLPoolProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LinkBalancerPoolWithCLPoolProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LinkBalancerPoolWithCLPoolProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LinkBalancerPoolWithCLPoolProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LinkBalancerPoolWithCLPoolProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LinkBalancerPoolWithCLPoolProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LinkBalancerPoolWithCLPoolProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
