...
var (
	...
	ErrEmptyPoolAssets          = sdkerrors.Register(ModuleName, 21, "PoolAssets not defined")
	ErrNegativeSwapFee          = sdkerrors.Register(ModuleName, 22, "swap fee is negative")
	ErrNegativeExitFee          = sdkerrors.Register(ModuleName, 23, "exit fee is negative")
	ErrTooMuchSwapFee           = sdkerrors.Register(ModuleName, 24, "swap fee should be lesser than 1 (100%)")
	ErrTooMuchExitFee           = sdkerrors.Register(ModuleName, 25, "exit fee should be lesser than 1 (100%)")
	ErrNotPositiveWeight        = sdkerrors.Register(ModuleName, 26, "token weight should be greater than 0")
	ErrWeightTooLarge           = sdkerrors.Register(ModuleName, 27, "user specified token weight should be less than 2^20")
	...
	ErrTooManyTokensOut         = sdkerrors.Register(ModuleName, 30, "tx is trying to get more tokens out of the pool than exist")
	ErrSpotPriceOverflow        = sdkerrors.Register(ModuleName, 31, "invalid spot price (overflowed)")
	ErrSpotPriceInternal        = sdkerrors.Register(ModuleName, 32, "internal spot price error")
