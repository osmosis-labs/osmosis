...
var (
	...
	ErrNotPositiveWeight        = sdkerrors.Register(ModuleName, 13, "token weight should be positive")
	ErrNotPositiveCriteria      = sdkerrors.Register(ModuleName, 14, "min out amount or max in amount should be positive")
	ErrNotPositiveRequireAmount = sdkerrors.Register(ModuleName, 15, "required amount should be positive")
)
