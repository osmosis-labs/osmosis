...
type MsgJoinPool struct {
	...
	PoolAmountOut github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=pool_amount_out,json=poolAmountOut,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"pool_amount_out" yaml:"pool_amount_out"`
	TokenInMax    []types.Coin                           `protobuf:"bytes,4,rep,name=token_in_max,json=tokenInMax,proto3" json:"token_in_max" yaml:"token_in_max_amounts"`
}
...
func (m *MsgJoinPool) GetTokenInMax() []types.Coin {
	if m != nil {
		return m.TokenInMax
	}
	return nil
...
func (m *SwapAmountOutRoute) GetTokenOutDenom() string {
	if m != nil {
		return m.TokenOutDenom
	}
	return ""
...
var fileDescriptor_cfc8fd3ac7df3247 = []byte{
	...
	,
}
...
func (m *MsgJoinPool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TokenInMax) > 0 {
		for iNdEx := len(m.TokenInMax) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TokenInMax[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgJoinPool) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TokenInMax", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TokenInMax = append(m.TokenInMax, types.Coin{})
			if err := m.TokenInMax[len(m.TokenInMax)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
