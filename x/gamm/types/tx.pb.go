...
type MsgJoinPoolResponse struct {
	ShareOutAmount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=share_out_amount,json=shareOutAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"share_out_amount" yaml:"pool_amount_out"`
	TokenIn        []types.Coin                           `protobuf:"bytes,2,rep,name=token_in,json=tokenIn,proto3" json:"token_in" yaml:"token_in_max_amounts"`
}
...
type MsgExitPoolResponse struct {
	ShareInAmount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=share_in_amount,json=shareInAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"share_in_amount" yaml:"pool_amount_out"`
	TokenOut      []types.Coin                           `protobuf:"bytes,2,rep,name=token_out,json=tokenOut,proto3" json:"token_out" yaml:"token_in_max_amounts"`
}
...
var fileDescriptor_cfc8fd3ac7df3247 = []byte{
	...
	,
}
