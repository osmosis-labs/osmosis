...
type TwapPair struct {
	...
	SpotPrice github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=spotPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"spotPrice"`
}
...
type PoolTwap struct {
	...
	SpotPrices []*TwapPair `protobuf:"bytes,3,rep,name=spotPrices,proto3" json:"spotPrices,omitempty"`
}
...
func (m *PoolTwap) GetStartTime() time.Time {
	if m != nil {
		return m.StartTime
	}
	return time.Time{}
...
func (m *PoolTwap) GetSpotPrices() []*TwapPair {
	if m != nil {
		return m.SpotPrices
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PoolTwap)(nil), "osmosis.gamm.v1beta1.PoolTwap")
}
...
var fileDescriptor_e5ab9bc6d45f98ce = []byte{
	...
	,
}
...
func (m *PoolTwap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SpotPrices) > 0 {
		for iNdEx := len(m.SpotPrices) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SpotPrices[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *PoolTwap) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpotPrices", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SpotPrices = append(m.SpotPrices, &TwapPair{})
			if err := m.SpotPrices[len(m.SpotPrices)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
