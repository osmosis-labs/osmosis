...
func (k Keeper) JoinSwapExactAmountIn(
	...
	ctx.Logger().Info("JoinSwapExactAmountIn", "poold id", poolId, "height", ctx.BlockHeight(), "pool type", pool.GetType())
	...
	ctx.Logger().Info("JoinSwapExactAmountIn final sharesOut", "sharesOut", sharesOut)
