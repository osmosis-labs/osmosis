...
// E.g. if pool 1 trades 2 atom for 3 melody, the quote asset was atom, and the base asset was melody,
// this would return 1.5. (Meaning that 1 atom costs 1.5 melody)
//
...
// by looking at the ratio of the total LP'd assets. (e.g. 2 melody : 1 atom)
