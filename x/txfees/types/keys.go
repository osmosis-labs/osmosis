...
const (
	...
	// NonNativeTxFeeCollectorName is the module account name for the alt fee collector account address (used for auto-swapping non-MLD tx fees).
	// N.B. MLD goes to authtypes.FeeCollectorName, matching the normal SDK flow.
