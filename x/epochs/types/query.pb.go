...
var fileDescriptor_574bd176519c765f = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	Epochs(ctx context.Context, in *QueryEpochsInfoRequest, opts ...grpc.CallOption) (*QueryEpochsInfoResponse, error)
}
...
func (c *queryClient) Epochs(ctx context.Context, in *QueryEpochsInfoRequest, opts ...grpc.CallOption) (*QueryEpochsInfoResponse, error) {
...
type QueryServer interface {
	// Epochs provide running epochs
	Epochs(context.Context, *QueryEpochsInfoRequest) (*QueryEpochsInfoResponse, error)
}
...
func (*UnimplementedQueryServer) Epochs(ctx context.Context, req *QueryEpochsInfoRequest) (*QueryEpochsInfoResponse, error) {
...
func _Query_Epochs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).Epochs(ctx, req.(*QueryEpochsInfoRequest))
	}
