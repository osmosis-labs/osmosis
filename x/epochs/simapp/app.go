...
func NewSimApp(
	...
	*/
	...
	app.mm.SetOrderBeginBlockers(
		...
		paramstypes.ModuleName, vestingtypes.ModuleName, epochstypes.ModuleName,
	)
	app.mm.SetOrderEndBlockers(
		...
		feegrant.ModuleName,
		paramstypes.ModuleName, upgradetypes.ModuleName, vestingtypes.ModuleName, epochstypes.ModuleName,
	)
