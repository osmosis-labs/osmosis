...
type TxExtension struct {
	...
	// message.
	SelectedAuthenticators []int64 `protobuf:"varint,1,rep,packed,name=selected_authenticators,json=selectedAuthenticators,proto3" json:"selected_authenticators,omitempty"`
}
...
func (m *TxExtension) GetSelectedAuthenticators() []int64 {
	if m != nil {
...
var fileDescriptor_1aa1d7e4dc71ed44 = []byte{
	...
	0x10, 0x6d, 0x9a, 0xd2, 0xef, 0xfb, 0xe6, 0x13, 0x91, 0x2d, 0xd6, 0x50, 0x61, 0x29, 0x39, 0x15,
	0xa1, 0x09, 0xb4, 0x48, 0xd1, 0x93, 0x15, 0xf4, 0xd6, 0xcb, 0xaa, 0x17, 0x2f, 0x92, 0x66, 0x87,
	...
	,
}
		...
		case 1:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.SelectedAuthenticators) == 0 {
					m.SelectedAuthenticators = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
