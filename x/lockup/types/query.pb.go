...
type AccumDebugRequest struct {
	MaxPoolId uint64 `protobuf:"varint,1,opt,name=max_pool_id,json=maxPoolId,proto3" json:"max_pool_id,omitempty"`
}

func (m *AccumDebugRequest) Reset()         { *m = AccumDebugRequest{} }
func (m *AccumDebugRequest) String() string { return proto.CompactTextString(m) }
func (*AccumDebugRequest) ProtoMessage()    {}
func (*AccumDebugRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e906fda01cffd91a, []int{40}
}
func (m *AccumDebugRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccumDebugRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccumDebugRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccumDebugRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccumDebugRequest.Merge(m, src)
}
func (m *AccumDebugRequest) XXX_Size() int {
	return m.Size()
}
func (m *AccumDebugRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AccumDebugRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AccumDebugRequest proto.InternalMessageInfo

func (m *AccumDebugRequest) GetMaxPoolId() uint64 {
	if m != nil {
		return m.MaxPoolId
	}
	return 0
...
type AccumDebugResponse struct {
	Keys   []string                                 `protobuf:"bytes,1,rep,name=keys,proto3" json:"keys,omitempty"`
	Values []string                                 `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
	Denoms []string                                 `protobuf:"bytes,3,rep,name=denoms,proto3" json:"denoms,omitempty"`
	Accums []github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,rep,name=accums,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"accums" yaml:"amount"`
}

func (m *AccumDebugResponse) Reset()         { *m = AccumDebugResponse{} }
func (m *AccumDebugResponse) String() string { return proto.CompactTextString(m) }
func (*AccumDebugResponse) ProtoMessage()    {}
func (*AccumDebugResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e906fda01cffd91a, []int{41}
}
func (m *AccumDebugResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccumDebugResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccumDebugResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccumDebugResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccumDebugResponse.Merge(m, src)
}
func (m *AccumDebugResponse) XXX_Size() int {
	return m.Size()
}
func (m *AccumDebugResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AccumDebugResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AccumDebugResponse proto.InternalMessageInfo

func (m *AccumDebugResponse) GetKeys() []string {
	if m != nil {
		return m.Keys
	}
	return nil
...
func (m *AccumDebugResponse) GetValues() []string {
	if m != nil {
		return m.Values
	}
	return nil
...
func (m *AccumDebugResponse) GetDenoms() []string {
	if m != nil {
		return m.Denoms
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LockRewardReceiverRequest)(nil), "osmosis.lockup.LockRewardReceiverRequest")
	proto.RegisterType((*LockRewardReceiverResponse)(nil), "osmosis.lockup.LockRewardReceiverResponse")
	proto.RegisterType((*NextLockIDRequest)(nil), "osmosis.lockup.NextLockIDRequest")
	proto.RegisterType((*NextLockIDResponse)(nil), "osmosis.lockup.NextLockIDResponse")
	...
	proto.RegisterType((*SyntheticLockupByLockupIDRequest)(nil), "osmosis.lockup.SyntheticLockupByLockupIDRequest")
	proto.RegisterType((*SyntheticLockupByLockupIDResponse)(nil), "osmosis.lockup.SyntheticLockupByLockupIDResponse")
	...
	proto.RegisterType((*AccumDebugRequest)(nil), "osmosis.lockup.AccumDebugRequest")
	proto.RegisterType((*AccumDebugResponse)(nil), "osmosis.lockup.AccumDebugResponse")
}
...
var fileDescriptor_e906fda01cffd91a = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// Params returns lockup params.
	AccumDebug(ctx context.Context, in *AccumDebugRequest, opts ...grpc.CallOption) (*AccumDebugResponse, error)
}
...
func (c *queryClient) LockRewardReceiver(ctx context.Context, in *LockRewardReceiverRequest, opts ...grpc.CallOption) (*LockRewardReceiverResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/osmosis.lockup.Query/LockRewardReceiver", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) NextLockID(ctx context.Context, in *NextLockIDRequest, opts ...grpc.CallOption) (*NextLockIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/osmosis.lockup.Query/NextLockID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SyntheticLockupByLockupID(ctx context.Context, in *SyntheticLockupByLockupIDRequest, opts ...grpc.CallOption) (*SyntheticLockupByLockupIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/osmosis.lockup.Query/SyntheticLockupByLockupID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AccumDebug(ctx context.Context, in *AccumDebugRequest, opts ...grpc.CallOption) (*AccumDebugResponse, error) {
	out := new(AccumDebugResponse)
	err := c.cc.Invoke(ctx, "/osmosis.lockup.Query/AccumDebug", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// Params returns lockup params.
	AccumDebug(context.Context, *AccumDebugRequest) (*AccumDebugResponse, error)
}
...
func (*UnimplementedQueryServer) AccumDebug(ctx context.Context, req *AccumDebugRequest) (*AccumDebugResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AccumDebug not implemented")
}
...
func _Query_LockRewardReceiver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.lockup.Query/LockRewardReceiver",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_NextLockID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.lockup.Query/NextLockID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SyntheticLockupByLockupID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.lockup.Query/SyntheticLockupByLockupID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AccumDebug_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AccumDebugRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).AccumDebug(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.lockup.Query/AccumDebug",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).AccumDebug(ctx, req.(*AccumDebugRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AccumDebug",
			Handler:    _Query_AccumDebug_Handler,
		},
	},
...
func (m *AccumDebugRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccumDebugRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccumDebugRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MaxPoolId != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.MaxPoolId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AccumDebugResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccumDebugResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccumDebugResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Accums) > 0 {
		for iNdEx := len(m.Accums) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.Accums[iNdEx].Size()
				i -= size
				if _, err := m.Accums[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintQuery(dAtA, i, uint64(size))
			}
...
func (m *AccumDebugRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MaxPoolId != 0 {
		n += 1 + sovQuery(uint64(m.MaxPoolId))
	}
	return n
}

func (m *AccumDebugResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AccumDebugRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccumDebugRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccumDebugRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxPoolId", wireType)
			}
			m.MaxPoolId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxPoolId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AccumDebugResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccumDebugResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccumDebugResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Accums", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Accums = append(m.Accums, v)
			if err := m.Accums[len(m.Accums)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
