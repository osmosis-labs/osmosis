...
// ===================== GetTakerFeeQueryMsg
type GetTakerFeeQueryMsg struct {
	// get_taker_fee is the query strcuture to get taker fee.
	GetTakerFee EmptyStruct `protobuf:"bytes,1,opt,name=get_taker_fee,json=getTakerFee,proto3" json:"get_taker_fee"`
}

func (m *GetTakerFeeQueryMsg) Reset()         { *m = GetTakerFeeQueryMsg{} }
func (m *GetTakerFeeQueryMsg) String() string { return proto.CompactTextString(m) }
func (*GetTakerFeeQueryMsg) ProtoMessage()    {}
func (*GetTakerFeeQueryMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_3251d17e76ef0dc1, []int{2}
}
func (m *GetTakerFeeQueryMsg) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetTakerFeeQueryMsg) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetTakerFeeQueryMsg.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetTakerFeeQueryMsg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetTakerFeeQueryMsg.Merge(m, src)
}
func (m *GetTakerFeeQueryMsg) XXX_Size() int {
	return m.Size()
}
func (m *GetTakerFeeQueryMsg) XXX_DiscardUnknown() {
	xxx_messageInfo_GetTakerFeeQueryMsg.DiscardUnknown(m)
}

var xxx_messageInfo_GetTakerFeeQueryMsg proto.InternalMessageInfo

func (m *GetTakerFeeQueryMsg) GetGetTakerFee() EmptyStruct {
	if m != nil {
		return m.GetTakerFee
	}
	return EmptyStruct{}
}

type GetTakerFeeQueryMsgResponse struct {
	// taker_fee is the taker fee for this swap estimate.
...
func (m *GetTakerFeeQueryMsgResponse) Reset()         { *m = GetTakerFeeQueryMsgResponse{} }
func (m *GetTakerFeeQueryMsgResponse) String() string { return proto.CompactTextString(m) }
func (*GetTakerFeeQueryMsgResponse) ProtoMessage()    {}
func (*GetTakerFeeQueryMsgResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3251d17e76ef0dc1, []int{3}
}
func (m *GetTakerFeeQueryMsgResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetTakerFeeQueryMsgResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetTakerFeeQueryMsgResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetTakerFeeQueryMsgResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetTakerFeeQueryMsgResponse.Merge(m, src)
}
func (m *GetTakerFeeQueryMsgResponse) XXX_Size() int {
	return m.Size()
}
func (m *GetTakerFeeQueryMsgResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetTakerFeeQueryMsgResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetTakerFeeQueryMsgResponse proto.InternalMessageInfo
...
func (*GetTotalSharesQueryMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_3251d17e76ef0dc1, []int{10}
}
...
func (*GetTotalSharesQueryMsgResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3251d17e76ef0dc1, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*GetTakerFeeQueryMsg)(nil), "osmosis.cosmwasmpool.v1beta1.GetTakerFeeQueryMsg")
	proto.RegisterType((*GetTakerFeeQueryMsgResponse)(nil), "osmosis.cosmwasmpool.v1beta1.GetTakerFeeQueryMsgResponse")
...
var fileDescriptor_3251d17e76ef0dc1 = []byte{
	...
	,
}
...
func (m *GetTakerFeeQueryMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetTakerFeeQueryMsg) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetTakerFeeQueryMsg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.GetTakerFee.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *GetTakerFeeQueryMsgResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetTakerFeeQueryMsgResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetTakerFeeQueryMsgResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetTakerFeeQueryMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.GetTakerFee.Size()
	n += 1 + l + sovPoolQueryMsg(uint64(l))
	return n
}

func (m *GetTakerFeeQueryMsgResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetTakerFeeQueryMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetTakerFeeQueryMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetTakerFeeQueryMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GetTakerFee", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GetTakerFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *GetTakerFeeQueryMsgResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetTakerFeeQueryMsgResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetTakerFeeQueryMsgResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 3:
			if wireType != 2 {
