...
var (
	pattern_Query_TaxRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"osmosis", "treasury", "v1beta1", "tax_rate"}, "", runtime.AssumeColonVerbOpt(false)))
