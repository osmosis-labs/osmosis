	...
	cases := []struct {
	...
	}{
		{
			...
			expectedRoute: []TestRoute{
				...
				{1, "akash", types.AtomDenomination},
				{25, types.AtomDenomination, types.OsmosisDenomination},
			},
			hasRoute:                 true,
		...
		},
		{
			...
			poolId:      1,
			expectedRoute: []TestRoute{
				{25, types.OsmosisDenomination, types.AtomDenomination},
				{1, types.AtomDenomination, "akash"},
			...
			expectedRoutes: [][]TestRoute{
				{
					{1, types.AtomDenomination, "akash"},
					{14, "akash", "bitcoin"},
					{4, "bitcoin", types.AtomDenomination},
				},
			},
