...
func (protoRevDec ProtoRevDecorator) PostHandle(ctx sdk.Context, tx sdk.Tx, simulate, success bool, next sdk.PostHandler) (sdk.Context, error) {
	...
	upperGasLimitMeter := storetypes.NewGasMeter(sdk.Gas(50_000_000))
	...
	protoRevDec.ProtoRevKeeper.DeleteSwapsToBackrun(ctx.WithGasMeter(storetypes.NewGasMeter(sdk.Gas(50_000_000))))
