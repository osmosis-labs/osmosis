...
func (protoRevDec ProtoRevDecorator) PostHandle(ctx sdk.Context, tx sdk.Tx, simulate, success bool, next sdk.PostHandler) (sdk.Context, error) {
	...
	upperGasLimitMeter := sdk.NewGasMeter(sdk.Gas(50_000_000), ctx.Logger())
	...
	protoRevDec.ProtoRevKeeper.DeleteSwapsToBackrun(ctx.WithGasMeter(sdk.NewGasMeter(sdk.Gas(50_000_000), ctx.Logger())))
