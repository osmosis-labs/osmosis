...
// BaseDenom contains the base denom that the module uses all of its arbitrage
// trades alongside the step size of the binary search that is used to find the
// optimal swap amount
type BaseDenom struct {
	// The denom that the module uses for all of its arbitrage trades
