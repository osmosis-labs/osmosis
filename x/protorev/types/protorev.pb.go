...
type InfoByPoolType struct {
	...
	Stable *StablePoolInfo `protobuf:"bytes,1,opt,name=stable,proto3" json:"stable,omitempty" yaml:"stable"`
	// The balancer pool info
	Balancer *BalancerPoolInfo `protobuf:"bytes,2,opt,name=balancer,proto3" json:"balancer,omitempty" yaml:"balancer"`
	// The concentrated pool info
	Concentrated *ConcentratedPoolInfo `protobuf:"bytes,3,opt,name=concentrated,proto3" json:"concentrated,omitempty" yaml:"concentrated"`
	// The cosmwasm pool info
	Cosmwasm *CosmwasmPoolInfo `protobuf:"bytes,4,opt,name=cosmwasm,proto3" json:"cosmwasm,omitempty" yaml:"cosmwasm"`
}
...
var fileDescriptor_1e9f2391fd9fec01 = []byte{
	...
	,
}
...
func (m *InfoByPoolType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Concentrated == nil {
				m.Concentrated = &ConcentratedPoolInfo{}
			}
