...
import (
	...
	types2 "github.com/osmosis-labs/osmosis/v20/x/txfees/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type AllProtocolRevenue struct {
	TakerFeesToStakersTracker       types1.TakerFeesToStakersTracker       `protobuf:"bytes,1,opt,name=taker_fees_to_stakers_tracker,json=takerFeesToStakersTracker,proto3" json:"taker_fees_to_stakers_tracker" yaml:"taker_fees_to_stakers_tracker"`
	TakerFeesToCommunityPoolTracker types1.TakerFeesToCommunityPoolTracker `protobuf:"bytes,2,opt,name=taker_fees_to_community_pool_tracker,json=takerFeesToCommunityPoolTracker,proto3" json:"taker_fees_to_community_pool_tracker" yaml:"taker_fees_to_community_pool_tracker"`
	TxFeesTracker                   types2.TxFeesTracker                   `protobuf:"bytes,3,opt,name=tx_fees_tracker,json=txFeesTracker,proto3" json:"tx_fees_tracker" yaml:"tx_fees_tracker"`
	CyclicArbTracker                CyclicArbTracker                       `protobuf:"bytes,4,opt,name=cyclic_arb_tracker,json=cyclicArbTracker,proto3" json:"cyclic_arb_tracker" yaml:"cyclic_arb_tracker"`
}
...
func (m *AllProtocolRevenue) GetTakerFeesToStakersTracker() types1.TakerFeesToStakersTracker {
	if m != nil {
		return m.TakerFeesToStakersTracker
	}
	return types1.TakerFeesToStakersTracker{}
}

func (m *AllProtocolRevenue) GetTakerFeesToCommunityPoolTracker() types1.TakerFeesToCommunityPoolTracker {
	if m != nil {
		return m.TakerFeesToCommunityPoolTracker
	}
	return types1.TakerFeesToCommunityPoolTracker{}
}
...
type CyclicArbTracker struct {
	CyclicArb                  github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=cyclic_arb,json=cyclicArb,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"cyclic_arb"`
...
func (m *CyclicArbTracker) GetCyclicArb() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.CyclicArb
	}
	return nil
...
func (m *CyclicArbTracker) GetHeightAccountingStartsFrom() uint64 {
	if m != nil {
...
var fileDescriptor_1e9f2391fd9fec01 = []byte{
	...
	,
}
