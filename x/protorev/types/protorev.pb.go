...
import (
	...
	types1 "github.com/osmosis-labs/osmosis/v23/x/poolmanager/types"
...
func (m *LastEpochProtorevModuleBalance) Reset()         { *m = LastEpochProtorevModuleBalance{} }
func (m *LastEpochProtorevModuleBalance) String() string { return proto.CompactTextString(m) }
func (*LastEpochProtorevModuleBalance) ProtoMessage()    {}
func (*LastEpochProtorevModuleBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_1e9f2391fd9fec01, []int{15}
}
func (m *LastEpochProtorevModuleBalance) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LastEpochProtorevModuleBalance) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LastEpochProtorevModuleBalance.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LastEpochProtorevModuleBalance) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LastEpochProtorevModuleBalance.Merge(m, src)
}
func (m *LastEpochProtorevModuleBalance) XXX_Size() int {
	return m.Size()
}
func (m *LastEpochProtorevModuleBalance) XXX_DiscardUnknown() {
	xxx_messageInfo_LastEpochProtorevModuleBalance.DiscardUnknown(m)
}

var xxx_messageInfo_LastEpochProtorevModuleBalance proto.InternalMessageInfo

func (m *LastEpochProtorevModuleBalance) GetBalance() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Balance
	}
	return nil
...
var fileDescriptor_1e9f2391fd9fec01 = []byte{
	...
	,
}
...
func (m *LastEpochProtorevModuleBalance) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LastEpochProtorevModuleBalance) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LastEpochProtorevModuleBalance) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LastEpochProtorevModuleBalance) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LastEpochProtorevModuleBalance) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LastEpochProtorevModuleBalance: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LastEpochProtorevModuleBalance: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
