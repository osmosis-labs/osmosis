...
// MsgUpdateBlacklist is the sdk.Msg type for allowing an admin account to blacklist or unblacklist
// a denom to be able to receive tokens
type MsgUpdateBlacklist struct {
	Sender      string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty" yaml:"sender"`
	Denom       string `protobuf:"bytes,2,opt,name=denom,proto3" json:"denom,omitempty" yaml:"denom"`
	Blacklistee string `protobuf:"bytes,3,opt,name=blacklistee,proto3" json:"blacklistee,omitempty" yaml:"address"`
	Status      bool   `protobuf:"varint,4,opt,name=status,proto3" json:"status,omitempty" yaml:"status"`
}
...
func (m *MsgUpdateBlacklist) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *MsgUpdateBlacklist) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *MsgUpdateBlacklist) GetBlacklistee() string {
	if m != nil {
		return m.Blacklistee
	}
	return ""
}

func (m *MsgUpdateBlacklist) GetStatus() bool {
	if m != nil {
		return m.Status
	}
	return false
...
// MsgUpdateBlacklistResponse defines the response structure for an executed
// MsgUpdateBlacklist message.
...
func init() {
	...
	proto.RegisterType((*MsgUpdateBlacklist)(nil), "osmosis.tokenfactory.v1beta1.MsgUpdateBlacklist")
	proto.RegisterType((*MsgUpdateBlacklistResponse)(nil), "osmosis.tokenfactory.v1beta1.MsgUpdateBlacklistResponse")
}
...
var fileDescriptor_283b6c9a90a846b4 = []byte{
	...
	,
}
...
func (c *msgClient) UpdateBlacklist(ctx context.Context, in *MsgUpdateBlacklist, opts ...grpc.CallOption) (*MsgUpdateBlacklistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/osmosis.tokenfactory.v1beta1.Msg/UpdateBlacklist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateBlacklist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.tokenfactory.v1beta1.Msg/UpdateBlacklist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgUpdateBlacklist) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Blacklistee) > 0 {
		i -= len(m.Blacklistee)
		copy(dAtA[i:], m.Blacklistee)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Blacklistee)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Denom) > 0 {
...
func (m *MsgUpdateBlacklist) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Blacklistee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Blacklistee = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
