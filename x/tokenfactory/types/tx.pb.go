...
// MsgAddSupplyOffset is the sdk.Msg type for allowing an admin account to change a
// denom's "supply offset"
type MsgAddSupplyOffset struct {
	Sender string                                 `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty" yaml:"sender"`
	Denom  string                                 `protobuf:"bytes,2,opt,name=denom,proto3" json:"denom,omitempty" yaml:"denom"`
	Offset github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=offset,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"offset" yaml:"offset"`
}

func (m *MsgAddSupplyOffset) Reset()         { *m = MsgAddSupplyOffset{} }
func (m *MsgAddSupplyOffset) String() string { return proto.CompactTextString(m) }
func (*MsgAddSupplyOffset) ProtoMessage()    {}
func (*MsgAddSupplyOffset) Descriptor() ([]byte, []int) {
	return fileDescriptor_283b6c9a90a846b4, []int{10}
}
func (m *MsgAddSupplyOffset) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddSupplyOffset) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddSupplyOffset.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddSupplyOffset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddSupplyOffset.Merge(m, src)
}
func (m *MsgAddSupplyOffset) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddSupplyOffset) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddSupplyOffset.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddSupplyOffset proto.InternalMessageInfo

func (m *MsgAddSupplyOffset) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *MsgAddSupplyOffset) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
// MsgAddSupplyOffsetResponse defines the response structure for an executed
// MsgAddSupplyOffset message.
type MsgAddSupplyOffsetResponse struct {
	NewTotalOffset github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=new_total_offset,json=newTotalOffset,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"offset" yaml:"new_total_offset"`
}

func (m *MsgAddSupplyOffsetResponse) Reset()         { *m = MsgAddSupplyOffsetResponse{} }
func (m *MsgAddSupplyOffsetResponse) String() string { return proto.CompactTextString(m) }
func (*MsgAddSupplyOffsetResponse) ProtoMessage()    {}
func (*MsgAddSupplyOffsetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_283b6c9a90a846b4, []int{11}
}
func (m *MsgAddSupplyOffsetResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddSupplyOffsetResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddSupplyOffsetResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddSupplyOffsetResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddSupplyOffsetResponse.Merge(m, src)
}
func (m *MsgAddSupplyOffsetResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddSupplyOffsetResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddSupplyOffsetResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddSupplyOffsetResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgAddSupplyOffset)(nil), "osmosis.tokenfactory.v1beta1.MsgAddSupplyOffset")
	proto.RegisterType((*MsgAddSupplyOffsetResponse)(nil), "osmosis.tokenfactory.v1beta1.MsgAddSupplyOffsetResponse")
}
...
var fileDescriptor_283b6c9a90a846b4 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	AddSupplyOffset(ctx context.Context, in *MsgAddSupplyOffset, opts ...grpc.CallOption) (*MsgAddSupplyOffsetResponse, error)
}
...
func (c *msgClient) AddSupplyOffset(ctx context.Context, in *MsgAddSupplyOffset, opts ...grpc.CallOption) (*MsgAddSupplyOffsetResponse, error) {
	out := new(MsgAddSupplyOffsetResponse)
	err := c.cc.Invoke(ctx, "/osmosis.tokenfactory.v1beta1.Msg/AddSupplyOffset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	AddSupplyOffset(context.Context, *MsgAddSupplyOffset) (*MsgAddSupplyOffsetResponse, error)
}
...
func (*UnimplementedMsgServer) AddSupplyOffset(ctx context.Context, req *MsgAddSupplyOffset) (*MsgAddSupplyOffsetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddSupplyOffset not implemented")
}
...
func _Msg_AddSupplyOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgAddSupplyOffset)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).AddSupplyOffset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/osmosis.tokenfactory.v1beta1.Msg/AddSupplyOffset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).AddSupplyOffset(ctx, req.(*MsgAddSupplyOffset))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddSupplyOffset",
			Handler:    _Msg_AddSupplyOffset_Handler,
		},
	},
...
func (m *MsgAddSupplyOffset) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddSupplyOffset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddSupplyOffset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgAddSupplyOffsetResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddSupplyOffsetResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddSupplyOffsetResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size := m.NewTotalOffset.Size()
		i -= size
		if _, err := m.NewTotalOffset.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTx(dAtA, i, uint64(size))
	}
...
func (m *MsgAddSupplyOffset) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgAddSupplyOffsetResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.NewTotalOffset.Size()
	n += 1 + l + sovTx(uint64(l))
	return n
}
...
func (m *MsgAddSupplyOffset) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddSupplyOffset: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddSupplyOffset: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgAddSupplyOffsetResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddSupplyOffsetResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddSupplyOffsetResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewTotalOffset", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NewTotalOffset.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
