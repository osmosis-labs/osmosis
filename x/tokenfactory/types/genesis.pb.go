...
type GenesisState struct {
	FactoryDenoms []GenesisDenom `protobuf:"bytes,1,rep,name=factory_denoms,json=factoryDenoms,proto3" json:"factory_denoms" yaml:"factory_denoms"`
}
...
var fileDescriptor_5749c3f71850298b = []byte{
	...
	,
	...
	0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0xa1, 0xae, 0xd2, 0xcd, 0x49, 0x4c, 0x2a, 0x86, 0x71,
	0xf4, 0xcb, 0xcc, 0xf5, 0x2b, 0x50, 0x63, 0xaf, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0x1c,
	0x55, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xec, 0xfa, 0xc9, 0x97, 0x42, 0x02, 0x00, 0x00,
}
...
func (this *GenesisState) Equal(that interface{}) bool {
	...
	if len(this.FactoryDenoms) != len(that1.FactoryDenoms) {
		return false
	}
	for i := range this.FactoryDenoms {
		if !this.FactoryDenoms[i].Equal(&that1.FactoryDenoms[i]) {
			return false
		}
	}
	return true
