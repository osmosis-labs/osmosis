...
type Farm struct {
	...
	CurrentPeriod  int64                                       `protobuf:"varint,3,opt,name=currentPeriod,proto3" json:"currentPeriod,omitempty" yaml:"current_period"`
	CurrentRewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,4,rep,name=currentRewards,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"currentRewards"`
}
...
type HistoricalRecord struct {
	CumulativeRewardRatio github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=cumulativeRewardRatio,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"cumulativeRewardRatio" yaml:"cumulative_reward_ratio"`
}
...
type Farmer struct {
	...
	LastWithdrawnPeriod int64                                  `protobuf:"varint,4,opt,name=lastWithdrawnPeriod,proto3" json:"lastWithdrawnPeriod,omitempty" yaml:"last_withdrawn_period"`
}
...
var fileDescriptor_2f2df01a0a5280ed = []byte{
	...
	,
}
