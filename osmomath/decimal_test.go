...
var (
	zeroAdditiveErrTolerance = osmomath.ErrTolerance{
		AdditiveTolerance: osmomath.ZeroSDKDec(),
	}
)
...
func (s *decimalTestSuite) TestSdkDec() {
	tests := []struct {
		d        osmomath.BigDec
		want     osmomath.SDKDec
		expPanic bool
	}{
		{osmomath.NewBigDec(0), osmomath.MustNewSDKDecFromStr("0.000000000000000000"), false},
		{osmomath.NewBigDec(1), osmomath.MustNewSDKDecFromStr("1.000000000000000000"), false},
		{osmomath.NewBigDec(10), osmomath.MustNewSDKDecFromStr("10.000000000000000000"), false},
		{osmomath.NewBigDec(12340), osmomath.MustNewSDKDecFromStr("12340.000000000000000000"), false},
		{osmomath.NewDecWithPrec(12340, 4), osmomath.MustNewSDKDecFromStr("1.234000000000000000"), false},
		{osmomath.NewDecWithPrec(12340, 5), osmomath.MustNewSDKDecFromStr("0.123400000000000000"), false},
		{osmomath.NewDecWithPrec(12340, 8), osmomath.MustNewSDKDecFromStr("0.000123400000000000"), false},
		{osmomath.NewDecWithPrec(1009009009009009009, 17), osmomath.MustNewSDKDecFromStr("10.090090090090090090"), false},
	}
	for tcIndex, tc := range tests {
		if tc.expPanic {
...
func (s *decimalTestSuite) TestSdkDecRoundUp() {
	tests := []struct {
		...
		{osmomath.NewDecWithPrec(12340, 8), osmomath.MustNewSDKDecFromStr("0.000123400000000000"), false},
		{osmomath.NewDecWithPrec(1009009009009009009, 17), osmomath.MustNewSDKDecFromStr("10.090090090090090090"), false},
		{osmomath.NewDecWithPrec(1009009009009009009, 19), osmomath.MustNewSDKDecFromStr("0.100900900900900901"), false},
	}
	for tcIndex, tc := range tests {
		if tc.expPanic {
...
func (s *decimalTestSuite) TestBigDecFromSdkDec() {
	tests := []struct {
		...
		{osmomath.MustNewSDKDecFromStr("0.000000000000000000"), osmomath.NewBigDec(0), false},
		{osmomath.MustNewSDKDecFromStr("1.000000000000000000"), osmomath.NewBigDec(1), false},
		{osmomath.MustNewSDKDecFromStr("10.000000000000000000"), osmomath.NewBigDec(10), false},
		{osmomath.MustNewSDKDecFromStr("12340.000000000000000000"), osmomath.NewBigDec(12340), false},
		{osmomath.MustNewSDKDecFromStr("1.234000000000000000"), osmomath.NewDecWithPrec(12340, 4), false},
		{osmomath.MustNewSDKDecFromStr("0.123400000000000000"), osmomath.NewDecWithPrec(12340, 5), false},
		{osmomath.MustNewSDKDecFromStr("0.000123400000000000"), osmomath.NewDecWithPrec(12340, 8), false},
		{osmomath.MustNewSDKDecFromStr("10.090090090090090090"), osmomath.NewDecWithPrec(1009009009009009009, 17), false},
	}
	for tcIndex, tc := range tests {
		if tc.expPanic {
...
func (s *decimalTestSuite) TestBigDecFromSdkDecSlice() {
	tests := []struct {
		...
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("0.000000000000000000")}, []osmomath.BigDec{osmomath.NewBigDec(0)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("0.000000000000000000"), osmomath.MustNewSDKDecFromStr("1.000000000000000000")}, []osmomath.BigDec{osmomath.NewBigDec(0), osmomath.NewBigDec(1)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("1.000000000000000000"), osmomath.MustNewSDKDecFromStr("0.000000000000000000"), osmomath.MustNewSDKDecFromStr("0.000123400000000000")}, []osmomath.BigDec{osmomath.NewBigDec(1), osmomath.NewBigDec(0), osmomath.NewDecWithPrec(12340, 8)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("10.000000000000000000")}, []osmomath.BigDec{osmomath.NewBigDec(10)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("12340.000000000000000000")}, []osmomath.BigDec{osmomath.NewBigDec(12340)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("1.234000000000000000"), osmomath.MustNewSDKDecFromStr("12340.000000000000000000")}, []osmomath.BigDec{osmomath.NewDecWithPrec(12340, 4), osmomath.NewBigDec(12340)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("0.123400000000000000"), osmomath.MustNewSDKDecFromStr("12340.000000000000000000")}, []osmomath.BigDec{osmomath.NewDecWithPrec(12340, 5), osmomath.NewBigDec(12340)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("0.000123400000000000"), osmomath.MustNewSDKDecFromStr("10.090090090090090090")}, []osmomath.BigDec{osmomath.NewDecWithPrec(12340, 8), osmomath.NewDecWithPrec(1009009009009009009, 17)}, false},
		{[]osmomath.SDKDec{osmomath.MustNewSDKDecFromStr("10.090090090090090090"), osmomath.MustNewSDKDecFromStr("10.090090090090090090")}, []osmomath.BigDec{osmomath.NewDecWithPrec(1009009009009009009, 17), osmomath.NewDecWithPrec(1009009009009009009, 17)}, false},
	}
	for tcIndex, tc := range tests {
		if tc.expPanic {
...
func (s *decimalTestSuite) TestPowerInteger() {
	...
	tests := map[string]struct {
		...
		"geom twap overflow: 2^log_2{max spot price / 2 - 2017}": { // 2017 is prime.
			base:     osmomath.TwoBigDec,
			exponent: uint64(osmomath.BigDecFromSDKDec(osmomath.MaxSpotPrice.Quo(osmomath.NewSDKDec(2)).Sub(osmomath.NewSDKDec(2017))).LogBase2().TruncateInt().Uint64()),

			// https://www.wolframalpha.com/input?i=e%5E10+41+digits
			expectedResult: osmomath.MustNewDecFromStr("85070591730234615865843651857942052864"),
		},

		// osmomath.SDKDec test vectors copied from osmosis-labs/cosmos-sdk:
