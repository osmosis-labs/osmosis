...
func (s *decimalTestSuite) TestDec_Mutative() {
	tests := []struct {
		...
		{osmomath.NewBigDec(0), sdk.MustNewDecFromStr("0.000000000000000000")},
		{osmomath.NewBigDec(1), sdk.MustNewDecFromStr("1.000000000000000000")},
		{osmomath.NewBigDec(10), sdk.MustNewDecFromStr("10.000000000000000000")},
		{osmomath.NewBigDec(12340), sdk.MustNewDecFromStr("12340.000000000000000000")},
		{osmomath.NewBigDecWithPrec(12340, 4), sdk.MustNewDecFromStr("1.234000000000000000")},
		{osmomath.NewBigDecWithPrec(12340, 5), sdk.MustNewDecFromStr("0.123400000000000000")},
		{osmomath.NewBigDecWithPrec(12340, 8), sdk.MustNewDecFromStr("0.000123400000000000")},
		{osmomath.NewBigDecWithPrec(1009009009009009009, 17), sdk.MustNewDecFromStr("10.090090090090090090")},
	}
